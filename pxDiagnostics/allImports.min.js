...
w:m+40,text:"ABC"},{x:1*b+40,w:m+40,text:"?123"},{x:2*b+80,text:","},{x:3*b+80,w:8*b-30-(3*b+90),text:""},{x:8*b-30,text:"."},{x:9*b-30,w:m+30,text:"Enter"}]}};this.xfinity_sans_default=a.create({t:"fontResource",url:f+"/fonts/XFINITYSansTT.ttf"});this.defaultResource=a.create({t:"imageResource",w:m,h:100,url:f+"/images/buttonBckground.svg"});this.highlightResource=a.create({t:"imageResource",w:m,h:100,url:f+"/images/buttonHighlight.svg"});this.backResource=a.create({t:"imageResource",w:40,h:40,url:f+
...
x:A,y:f,w:p,h:50,resource:g.defaultResource}),d=a.create({t:"textBox",parent:v,textColor:c.WHITE,w:v.w,h:v.h,pixelSize:25,text:b.text,font:g.xfinity_sans_default,alignHorizontal:a.alignHorizontal.CENTER,alignVertical:a.alignVertical.CENTER}),2==e&&"SHIFT"==b.text?(d.a=0,g.shiftImage.parent=v,g.shiftImage.x=v.w/2-20,g.shiftImage.y=v.h/2-17.5,g.shiftImage.resource=g.shiftFillResource):2==e&&"shift"==b.text?(d.a=0,g.shiftImage.parent=v,g.shiftImage.x=v.w/2-20,g.shiftImage.y=v.h/2-17.5,g.shiftImage.resource=
...
(e["Device.DeviceInfo.X_RDKCENTRAL-COM_xBlueTooth.Enabled"]=c.addRow("Bluetooth Status","TODO"),e["Device.DeviceInfo.X_RDKCENTRAL-COM_xBlueTooth.DeviceInfo.Profile"]=c.addRow("Bluetooth Active Profile","TODO"),e["Device.DeviceInfo.X_RDKCENTRAL-COM_xBlueTooth.DeviceInfo.Manufacturer"]=c.addRow("Bluetooth Active Make/Model","TODO"));0==d.isClientDevice&&(c.addRow("State Code","TODO"),c.addRow("County Code","TODO"),c.addRow("County Sub-Division Code","TODO"))};this.updateData=function(){d.doHttpPost({hostname:"localhost",
...
m=px.getPackageBaseFilePath(),t=-1,u=-1,n=[],h=[],z=[],x=b.context,k=b.parent;b=f.alignHorizontal.CENTER;var r=f.alignHorizontal.LEFT,w=f.alignHorizontal.RIGHT,p=f.alignVertical.CENTER,v=f.animation.TWEEN_EXP1,A=f.animation.OPTION_FASTFORWARD,B=f.animation.TWEEN_LINEAR,G=f.animation.OPTION_LOOP,P=this,C=f.create({t:"fontResource",url:m+"/fonts/XFINITYSansTT.ttf"});this.onPopulateDevices=function(a){z=a;n.length=0;F.y=0;t=u=-1;N.hide();0==z.length?(F.removeAll(),Q.a=0,0===h.length&&(O.focus=!0,M.resource=
...
m=global.registry.all.BtConnectivityScreen,t=global.registry.all.Popup,u=global.registry.keyCodes,n=null,h=null,z=px.getPackageBaseFilePath(),x=b.create({t:"fontResource",url:z+"/fonts/XFINITYSansTT.ttf"});console.time("App start");console.time("Startup action");var k={user_accepted_pairing:!1,known_devices:null,discovered_devices:null,paired_devices:null,connected_devices:null,_owner:null,_actions:new Map,_aip:!1,_aip_handler:null,_aip_timeout:30,_aip_timer_id:null,populateDevices:function(){var a=
...
var CableCardStatus=function(a){var b=global.registry.all.DetailsItem,d=global.registry.all.Utils,e={};this.show=function(){var c=new b(d.scene,a);c.setSeparatorPlacement(.3);e["Device.DeviceInfo.UpTime"]=c.addRow("Uptime","TODO");e["Device.DeviceInfo.Manufacturer"]=c.addRow("Manufacturer","TODO");e["Device.Time.LocalTimeZone"]=c.addRow("Time Zone","TODO")};this.updateData=function(){var a={hostname:"localhost",port:10999,method:"POST",headers:{"Content-Type":"application/json"}};d.doHttpPost(a,'{"paramList" : [               {"name" : "Device.DeviceInfo.UpTime"},               {"name" : "Device.DeviceInfo.Manufacturer"},               {"name" : "Device.Time.LocalTimeZone"},               {"name" : "Device.DeviceInfo.ModelName"}               ]}').then(function(a){console.log("got successful response from tr69 service");
...
var CanhStatus5=function(a){var b=global.registry.all.DetailsItem,d=global.registry.all.Utils,e={};this.show=function(){var c=new b(d.scene,a);c.setSeparatorPlacement(.4);c.addRow("Prgind","TODO");c.addRow("Prgind","TODO");c.addRow("Prgind","TODO")};this.updateData=function(){var a={hostname:"localhost",port:10999,method:"POST",headers:{"Content-Type":"application/json"}};d.doHttpPost(a,'{"paramList" : [               {"name" : "Device.X_COMCAST-COM_Xcalibur.TRM.trmGatewaySTBMAC"}               ]}').then(function(a){console.log("got successful response from tr69 service");
...
var CanhStatus6=function(a){var b=global.registry.all.DetailsItem,d=global.registry.all.Utils,e={};this.show=function(){var c=new b(d.scene,a);c.setSeparatorPlacement(.4);c.addRow("Status","TODO");c.addRow("No errors","TODO");c.addRow("Pending Purchase List in Hex","TODO");c.addRow("None","TODO")};this.updateData=function(){var a={hostname:"localhost",port:10999,method:"POST",headers:{"Content-Type":"application/json"}};d.doHttpPost(a,'{"paramList" : [               {"name" : "Device.X_COMCAST-COM_Xcalibur.TRM.trmGatewaySTBMAC"}               ]}').then(function(a){console.log("got successful response from tr69 service");
...
c.addRow("CM Status","TODO")};this.updateData=function(){var a={hostname:"localhost",port:10999,method:"POST",headers:{"Content-Type":"application/json"}};d.doHttpPost(a,'{"paramList" : [               {"name" : "Device.X_COMCAST-COM_Xcalibur.TRM.trmGatewaySTBMAC"}               ]}').then(function(a){console.log("got successful response from tr69 service");console.log("parse value is "+a.paramList[0].value);for(var b=0;b<a.paramList.length;b++)e[a.paramList[b].name].text=a.paramList[b].value},function(b){console.log("inside errorCallback");
...
c.addRowRight("Reportback Status","TODO");c.addRowRight("CC MAC Addr","TODO");c.addRowRight("IP_U Address","TODO");c.addRowRight("RB Flow Status","TODO");c.addRowRight("RADD Addr Status","TODO");c.addRowRight("Auto Reg. Status","TODO")};this.updateData=function(){var a={hostname:"localhost",port:10999,method:"POST",headers:{"Content-Type":"application/json"}};d.doHttpPost(a,'{"paramList" : [               {"name" : "Device.DeviceInfo.X_COMCAST-COM_STB_MAC"},               {"name" : "Device.X_COMCAST-COM_Xcalibur.TRM.trmGatewaySTBMAC"},               {"name" : "Device.Time.LocalTimeZone"}               ]}').then(function(a){console.log("got successful response from tr69 service");
...
"0")};this.updateData=function(){var a={hostname:"localhost",port:10999,method:"POST",headers:{"Content-Type":"application/json"}};d.doHttpPost(a,'{"paramList" : [               {"name" : "Device.X_COMCAST-COM_Xcalibur.TRM.trmGatewaySTBMAC"}               ]}').then(function(a){console.log("got successful response from tr69 service");console.log("parse value is "+a.paramList[0].value);for(var b=0;b<a.paramList.length;b++)e[a.paramList[b].name].text=a.paramList[b].value},function(b){console.log("inside errorCallback");
...
var HostPropertiesStatus=function(a){var b=global.registry.all.DetailsItem,d=global.registry.all.Utils,e={};this.show=function(){var c=new b(d.scene,a);c.setSeparatorPlacement(.3);e["Device.DeviceInfo.SerialNumber"]=c.addRow("Serial Number","TODO");e["Device.DeviceInfo.ModelName"]=c.addRow("Model Name","TODO");e["Device.DeviceInfo.Manufacturer"]=c.addRow("Vendor Name","TODO");e["Device.DeviceInfo.MemoryStatus.Total"]=c.addRow("Total Memory","TODO")};this.updateData=function(){var a={hostname:"localhost",
...
var InBandNetworkStatus=function(a){var b=global.registry.all.DetailsItem,d=global.registry.all.Utils,e={};this.show=function(){var c=new b(d.scene,a);c.setSeparatorPlacement(.3);c.addRow("Tuner","Frequency(hertz)");c.addRow("Tuner-1","TODO");c.addRow("Tuner-2","TODO");c.addRow("Tuner-3","TODO");c.addRow("Tuner-4","TODO");c.addRow("Tuner-5","TODO");c.addRow("Tuner-6","TODO")};this.updateData=function(){var a={hostname:"localhost",port:10999,method:"POST",headers:{"Content-Type":"application/json"}};
...
c.addRow("ManufacturerCertSubjectName","TODO");c.addRow("ManufacturerCertIssuerName","TODO")};this.updateData=function(){var a={hostname:"localhost",port:10999,method:"POST",headers:{"Content-Type":"application/json"}};d.doHttpPost(a,'{"paramList" : [               {"name" : "Device.DeviceInfo.ModelName"}               ]}').then(function(a){console.log("got successful response from tr69 service");console.log("parse value is "+a.paramList[0].value);for(var b=0;b<a.paramList.length;b++)e[a.paramList[b].name].text=
...
var TunerStatus=function(a){var b=global.registry.all.DetailsItem,d=global.registry.all.Utils,e={};this.show=function(){var c=new b(d.scene,a);c.setSeparatorPlacement(.5);e["Device.X_COMCAST-COM_Xcalibur.TRM.trmGatewaySTBMAC"]=c.addRowLeft("TRM eSTB MAC","TODO");e["Device.X_COMCAST-COM_Xcalibur.TRM.trmGatewayMoCAMAC"]=c.addRowLeft("TRM MoCA MAC","TODO")};this.updateData=function(){d.doHttpPost({hostname:"localhost",port:10999,method:"POST",headers:{"Content-Type":"application/json"}},'{"paramList" : [               {"name" : "Device.X_COMCAST-COM_Xcalibur.TRM.trmGatewaySTBMAC"},               {"name" : "Device.X_COMCAST-COM_Xcalibur.TRM.trmGatewayMoCAMAC"}               ]}').then(function(a){for(var b=
...
"TODO");c.addRowRight("UDP Port Range 2","TODO");c.addRowRight("UCIDs","TODO")};this.updateData=function(){var a={hostname:"localhost",port:10999,method:"POST",headers:{"Content-Type":"application/json"}};d.doHttpPost(a,'{"paramList" : [               {"name" : "Device.DeviceInfo.X_COMCAST-COM_STB_MAC"},               {"name" : "Device.X_COMCAST-COM_Xcalibur.TRM.trmGatewaySTBMAC"},               {"name" : "Device.Time.LocalTimeZone"}               ]}').then(function(a){console.log("got successful response from tr69 service");
...
var VodStatus=function(a){var b=global.registry.all.DetailsItem,d=global.registry.all.Utils,e={};this.show=function(){var c=new b(d.scene,a);c.setSeparatorPlacement(.3);e["Device.X_COMCAST-COM_Xcalibur.Client.XRE.xreVodId"]=c.addRow("VOD ID","TODO")};this.updateData=function(){d.doHttpPost({hostname:"localhost",port:10999,method:"POST",headers:{"Content-Type":"application/json"}},'{"paramList" : [               {"name" : "Device.X_COMCAST-COM_Xcalibur.Client.XRE.xreVodId"}               ]}').then(function(a){for(var b=
...
function WifiPassword(a,b){var d=b.keys,e=b.Colors,c=b.device,f=b.EditBox,l=b.Keyboard,q=b.eventManager;b=b.parent;var g=this,m=null,t=a.alignHorizontal.CENTER,u=a.alignVertical.CENTER,n=global.registry.baseUrl;this.xfinity_sans_default=a.create({t:"fontResource",url:n+"/fonts/XFINITYSansTT.ttf"});this.container=a.create({t:"rect",parent:b,w:b.w,h:b.h,fillColor:808464639,interactive:!1});this.title=a.create({t:"textBox",parent:this.container,textColor:e.WHITE,x:a.w/2-150,y:0,w:300,h:40,pixelSize:28,
text:"Wi-Fi password",font:this.xfinity_sans_default,alignHorizontal:t,alignVertical:u});this.subTitle=a.create({t:"textBox",parent:this.container,textColor:e.WHITE,x:a.w/2-200,y:this.title.y+50,w:400,h:30,pixelSize:20,text:"Enter the password for "+c.ssid,font:this.xfinity_sans_default,alignHorizontal:t,alignVertical:u,a:.8});this.subTitle1=a.create({t:"rect",parent:this.container,x:a.w/2-200,y:this.subTitle.y+35,w:400,h:50,lineWidth:4,lineColor:e.BACKGROUND1,fillColor:e.TRANSPARENT});this.inputBox=
new f({parent:this.subTitle1,x:5,w:this.subTitle1.w-10,h:this.subTitle1.h,pts:30,text_color:4294967295,font:n+"/fonts/XFINITYSansTT.ttf"});this.checkbox=a.create({t:"rect",parent:this.container,x:this.subTitle1.x,y:this.subTitle1.y+60,w:30,h:30,lineWidth:4,lineColor:e.BACKGROUND1,fillColor:e.TRANSPARENT});this.checkResource=a.create({t:"imageResource",w:16,h:16,url:n+"/images/check.svg"});this.checkImage=a.create({t:"image",parent:this.checkbox,w:this.checkbox.w,h:this.checkbox.h,x:7,y:7,resource:this.checkResource,
a:0});this.showPasswordText=a.create({t:"textBox",parent:this.container,textColor:e.WHITE,x:this.checkbox.x+40,y:this.subTitle1.y+60,w:400,h:30,pixelSize:20,text:"Show password",font:this.xfinity_sans_default,alignVertical:u});this.cancelRect=a.create({t:"rect",parent:this.container,x:this.subTitle1.x+this.subTitle1.w-220,y:this.subTitle1.y+110,w:100,h:40,fillColor:e.BTNBACKGROUND});this.cancelText=a.create({t:"textBox",parent:this.cancelRect,textColor:e.WHITE,w:this.cancelRect.w,h:this.cancelRect.h,
pixelSize:20,text:"Cancel",font:this.xfinity_sans_default,alignHorizontal:t,alignVertical:u});this.connectRect=a.create({t:"rect",parent:this.container,x:this.cancelRect.x+this.cancelRect.w+20,y:this.subTitle1.y+110,w:100,h:40,fillColor:e.BTNBACKGROUND});this.connectText=a.create({t:"textBox",parent:this.connectRect,textColor:e.WHITE,w:this.connectRect.w,h:this.connectRect.h,pixelSize:20,text:"Connect",font:this.xfinity_sans_default,alignHorizontal:t,alignVertical:u});this.loadingContainer=a.create({t:"object",
...
resource:h.imageBGResource});this.signalImage=e.create({t:"image",parent:this.signalImageBG,w:30,h:30,x:5,y:5,resource:this.signalImage(this.device.signalStrength)});this.securityImage=e.create({t:"image",parent:this.itemRoot,w:22,h:30,x:75,y:this.itemRoot.h/2-10,a:0<this.device.security?1:0,resource:h.securityResource});this.deviceName=e.create({t:"textBox",parent:this.itemRoot,textColor:f.TEXT,font:h.xfinity_sans_default,w:this.itemRoot.w,h:this.itemRoot.h,x:110,pixelSize:25,text:a.name,alignHorizontal:v,
alignVertical:A});this.deviceNameMargineLine=e.create({t:"rect",parent:this.itemRoot,w:this.itemRoot.w,h:2,y:this.itemRoot.h-2,fillColor:f.BLACK,a:.3});this.connectBG=e.create({t:"image",parent:this.itemRoot,w:120,h:30,x:this.itemRoot.w-180,y:this.itemRoot.h/2-15,resource:h.connectBGResource});this.status=e.create({t:"textBox",parent:this.connectBG,textColor:f.LIST_HIGHLIGHT,font:h.xfinity_sans_default,w:this.connectBG.w,h:this.connectBG.h,pixelSize:15,text:this.device.connected?"CONNECTED":"CONNECT",
...
this.xfinity_sans_default=e.create({t:"fontResource",url:n+"/fonts/XFINITYSansTT.ttf"});this.xfinity_sans_medium=e.create({t:"fontResource",url:n+"/fonts/XFINITYSansTT-Medium.ttf"});this.container=e.create({t:"object",parent:a,w:a.w,h:a.h,interactive:!1});this.title=e.create({t:"textBox",parent:this.container,textColor:f.TEXT,x:15,y:20,w:650,h:40,pixelSize:28,text:"Xfinity WiFi Settings",cx:325,cy:20,font:this.xfinity_sans_default,alignHorizontal:v,alignVertical:A});this.rightLayout=e.create({t:"object",
...
global.registry.all.Colors,z=global.registry.all.Logger,x=px.getPackageBaseFilePath(),k=null,r=null,w=c.create({t:"fontResource",url:x+"/fonts/XFINITYSansTT.ttf"}),p={user_accepted_pairing:!1,known_devices:null,discovered_devices:null,paired_devices:null,connected_devices:null,_owner:null,_actions:new Map,_aip:!1,_aip_handler:null,_aip_timeout:30,_aip_timer_id:null,populateDevices:function(){var a=this;this.known_devices=new Map;this._owner.log("Populating devices.");if(this.paired_devices&&0<this.paired_devices.length){for(var b=
...
c.addRow("FailedRetransCount","TODO");c.addRow("RetryCount","TODO");c.addRow("MultipleRetryCount","TODO");c.addRow("ACKFailureCount","TODO");c.addRow("AggregatedPacketCount","TODO");e["Device.WiFi.SSID.1.Stats.ErrorsSent"]=c.addRow("ErrorsSent","TODO");e["Device.WiFi.SSID.1.Stats.ErrorsReceived"]=c.addRow("ErrorsReceived","TODO")};this.updateData=function(){d.doHttpPost({hostname:"localhost",port:10999,method:"POST",headers:{"Content-Type":"application/json"}},'{"paramList" : [               {"name" : "Device.WiFi.SSID.1.Stats.BytesSent"},               {"name" : "Device.WiFi.SSID.1.Stats.BytesReceived"},               {"name" : "Device.WiFi.SSID.1.Stats.PacketsSent"},               {"name" : "Device.WiFi.SSID.1.Stats.PacketsReceived"},               {"name" : "Device.WiFi.SSID.1.Stats.ErrorsSent"},               {"name" : "Device.WiFi.SSID.1.Stats.ErrorsReceived"}               ]}').then(function(a){for(var b=
