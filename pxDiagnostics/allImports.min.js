...
$jscomp.polyfill("WeakMap",function(a){function b(){if(!a||!Object.seal)return!1;try{var b=Object.seal({}),c=Object.seal({}),d=new a([[b,2],[c,3]]);if(2!=d.get(b)||3!=d.get(c))return!1;d.delete(b);d.set(c,4);return!d.has(b)&&4==d.get(c)}catch(v){return!1}}function d(){}function e(a){if(!$jscomp.owns(a,f)){var b=new d;$jscomp.defineProperty(a,f,{value:b})}}function c(a){var b=Object[a];b&&(Object[a]=function(a){if(a instanceof d)return a;e(a);return b(a)})}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&
$jscomp.ES6_CONFORMANCE)return a}else if(b())return a;var f="$jscomp_hidden_"+Math.random();c("freeze");c("preventExtensions");c("seal");var m=0,q=function(a){this.id_=(m+=Math.random()+1).toString();if(a){a=$jscomp.makeIterator(a);for(var b;!(b=a.next()).done;)b=b.value,this.set(b[0],b[1])}};q.prototype.set=function(a,b){e(a);if(!$jscomp.owns(a,f))throw Error("WeakMap key fail: "+a);a[f][this.id_]=b;return this};q.prototype.get=function(a){return $jscomp.owns(a,f)?a[f][this.id_]:void 0};q.prototype.has=
...
if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(b())return a;$jscomp.initSymbolIterator();var d=new WeakMap,e=function(a){this.data_={};this.head_=m();this.size=0;if(a){a=$jscomp.makeIterator(a);for(var b;!(b=a.next()).done;)b=b.value,this.set(b[0],b[1])}};e.prototype.set=function(a,b){a=0===a?0:a;var d=c(this,a);d.list||(d.list=this.data_[d.id]=[]);d.entry?d.entry.value=b:(d.entry={next:this.head_,previous:this.head_.previous,head:this.head_,key:a,
value:b},d.list.push(d.entry),this.head_.previous.next=d.entry,this.head_.previous=d.entry,this.size++);return this};e.prototype.delete=function(a){a=c(this,a);return a.entry&&a.list?(a.list.splice(a.index,1),a.list.length||delete this.data_[a.id],a.entry.previous.next=a.entry.next,a.entry.next.previous=a.entry.previous,a.entry.head=null,this.size--,!0):!1};e.prototype.clear=function(){this.data_={};this.head_=this.head_.previous=m();this.size=0};e.prototype.has=function(a){return!!c(this,a).entry};
...
c||"function"==c?d.has(b)?c=d.get(b):(c=""+ ++q,d.set(b,c)):c="p_"+b;var e=a.data_[c];if(e&&$jscomp.owns(a.data_,c))for(a=0;a<e.length;a++){var f=e[a];if(b!==b&&f.key!==f.key||b===f.key)return{id:c,list:e,index:a,entry:f}}return{id:c,list:e,index:-1,entry:void 0}},f=function(a,b){var c=a.head_;return $jscomp.iteratorPrototype(function(){if(c){for(;c.head!=a.head_;)c=c.previous;for(;c.next!=c.head;)return c=c.next,{done:!1,value:b(c)};c=null}return{done:!0,value:void 0}})},m=function(){var a={};return a.previous=
...
$jscomp.polyfill("String.prototype.startsWith",function(a){return a?a:function(a,d){var b=$jscomp.checkStringArgs(this,a,"startsWith");a+="";var c=b.length,f=a.length;d=Math.max(0,Math.min(d|0,b.length));for(var m=0;m<f&&d<c;)if(b[d++]!=a[m++])return!1;return m>=f}},"es6","es3");
...
c)})};c.all=function(a){var b=$jscomp.makeIterator(a),e=b.next();return e.done?d([]):new c(function(a,c){function f(b){return function(c){m[b]=c;g--;0==g&&a(m)}}var m=[],g=0;do m.push(void 0),g++,d(e.value).callWhenSettled_(f(m.length-1),c),e=b.next();while(!e.done)})};return c},"es6","es3");
$jscomp.polyfill("Array.from",function(a){return a?a:function(a,d,e){d=null!=d?d:function(a){return a};var b=[],f="undefined"!=typeof Symbol&&Symbol.iterator&&a[Symbol.iterator];if("function"==typeof f){a=f.call(a);for(var m=0;!(f=a.next()).done;)b.push(d.call(e,f.value,m++))}else for(f=a.length,m=0;m<f;m++)b.push(d.call(e,a[m],m));return b}},"es6","es3");var Options={debug:"off",emulation:"off"};module.exports.Options=Options;
...
var DetailsItem=function(a,b){function d(){var a=g.getChild(g.numChildren-1);a.y+a.h>=g.h&&(g.h=a.y+a.h+25)}this.model=b;var e=global.registry.all.Utils,c=0,f=0,m=0,q=.6,g=a.create({t:"rect",parent:this.model.parent,x:this.model.x,y:this.model.y,w:this.model.w,h:this.model.h,lineWidth:1,lineColor:e.blackSolidColor,fillColor:3132799743});b=a.create({t:"rect",parent:g,x:1,w:g.w-2,h:35,lineColor:e.transparentColor,fillColor:e.xfinityBlueColor});var n=(g.w-e.boldFont.measureText(18,this.model.title).w)/
2,r=(b.h-e.boldFont.measureText(18,this.model.title).h)/2;a.create({t:"text",parent:g,x:n,y:r,w:160,h:25,text:this.model.title,font:e.boldFont,pixelSize:18,alignHorizontal:a.alignHorizontal.CENTER,textColor:e.charcoalGreyColor});var v=b.y+b.h+20,p=v,k=v;this.addRow=function(b,f,m){var l=3520188927,k=3907578111;0!=c%2&&(l=3907578111,k=3520188927);1==(void 0===m?!1:m)&&(v+=20);l=a.create({t:"rect",parent:g,x:20,y:v,w:g.w-40,h:25,fillColor:l});b=a.create({t:"text",parent:l,x:5,y:5,w:160,h:25,text:b,
font:e.boldFont,pixelSize:12,alignHorizontal:a.alignHorizontal.CENTER,textColor:e.charcoalGreyColor});m=a.create({t:"rect",parent:l,x:l.w*q,w:1,h:l.h,fillColor:k});k=a.create({t:"textBox",parent:l,x:m.x+5,y:5,w:400,h:25,text:f,font:e.regularFont,pixelSize:11,alignHorizontal:a.alignHorizontal.LEFT,textColor:e.blackSolidColor,wordWrap:!0});f=k.measureText(f).bounds;if(l.h<f.y2-f.y1){var t=l.h;l.h=f.y2-f.y1+10;m.h=l.h;b.y+=(l.h-t)/2;v+=l.h}else v+=25;c++;d();return k};this.addRowLeft=function(b,c,m){var l=
3520188927,k=3907578111;0!=f%2&&(l=3907578111,k=3520188927);1==(void 0===m?!1:m)&&(p+=20);l=a.create({t:"rect",parent:g,x:20,y:p,w:(g.w-60)/2,h:25,fillColor:l});b=a.create({t:"text",parent:l,x:5,y:5,w:80,h:25,text:b,font:e.boldFont,pixelSize:12,alignHorizontal:a.alignHorizontal.CENTER,textColor:e.charcoalGreyColor});m=a.create({t:"rect",parent:l,x:l.w*q,w:1,h:l.h,fillColor:k});k=a.create({t:"textBox",parent:l,x:m.x+5,y:5,w:120,h:25,text:c,font:e.regularFont,pixelSize:11,alignHorizontal:a.alignHorizontal.LEFT,
textColor:e.blackSolidColor,wordWrap:!0});c=k.measureText(c).bounds;if(l.h<c.y2-c.y1){var t=l.h;l.h=c.y2-c.y1+10;m.h=l.h;b.y+=(l.h-t)/2;p+=l.h}else p+=25;f++;d();return k};this.addRowRight=function(b,c,f){var l=3520188927,y=3907578111;0!=m%2&&(l=3907578111,y=3520188927);1==(void 0===f?!1:f)&&(k+=20);l=a.create({t:"rect",parent:g,x:(g.w-60)/2+40,y:k,w:(g.w-60)/2,h:25,fillColor:l});b=a.create({t:"text",parent:l,x:5,y:5,w:80,h:25,text:b,font:e.boldFont,pixelSize:12,alignHorizontal:a.alignHorizontal.CENTER,
textColor:e.charcoalGreyColor});f=a.create({t:"rect",parent:l,x:l.w*q,w:1,h:l.h,fillColor:y});y=a.create({t:"textBox",parent:l,x:f.x+5,y:5,w:120,h:25,text:c,font:e.regularFont,pixelSize:11,alignHorizontal:a.alignHorizontal.LEFT,textColor:e.blackSolidColor,wordWrap:!0});c=y.measureText(c).bounds;if(l.h<c.y2-c.y1){var t=l.h;l.h=c.y2-c.y1+10;f.h=l.h;b.y+=(l.h-t)/2;k+=l.h}else k+=25;m++;d();return y};this.setSeparatorPlacement=function(a){q=a};this.setHeight=function(a){g.h=a}};
module.exports.DetailsItem=DetailsItem;
var DialogItem=function(a,b,d,e){var c=global.registry.root,f=global.registry.all.Utils,m=a.create({t:"rect",parent:c,x:(c.w-500)/2,y:(c.h-240)/2,w:500,h:240,lineWidth:2,lineColor:f.blackSolidColor,fillColor:f.charcoalGreyColor});c=a.create({t:"text",parent:m,x:40,y:40,w:160,h:25,text:b.title,font:f.boldFont,pixelSize:20,alignHorizontal:a.alignHorizontal.CENTER,textColor:f.xfinityBlueColor});b=a.create({t:"text",parent:m,x:40,y:c.y+c.h+30,w:160,h:25,text:b.mainText,font:f.regularFont,pixelSize:18,
alignHorizontal:a.alignHorizontal.CENTER,textColor:f.textColor});b=a.create({t:"rect",parent:m,x:40,y:b.y+b.h+40,w:m.w-80,lineWidth:1,h:1,lineColor:f.greyColor,fillColor:f.greyColor});c=40+(b.w/2-f.regularFont.measureText(18,"OK").w)/2;a.create({t:"text",parent:m,x:c,y:b.y+b.h+15,h:25,text:"OK",font:f.boldFont,pixelSize:18,alignHorizontal:a.alignHorizontal.CENTER,textColor:f.textColor});var q=a.create({t:"rect",parent:m,x:40,y:b.y,w:b.w/2,lineWidth:2,h:5,lineColor:f.xfinityBlueColor,fillColor:f.xfinityBlueColor});
c=40+b.w/2+(b.w/2-f.regularFont.measureText(18,"Cancel").w)/2;c=a.create({t:"text",parent:m,x:c,y:b.y+b.h+15,h:25,text:"Cancel",font:f.boldFont,pixelSize:18,alignHorizontal:a.alignHorizontal.CENTER,textColor:f.textColor});var g=a.create({t:"rect",parent:m,x:40+b.w/2,y:b.y,w:b.w/2,lineWidth:2,h:5,lineColor:f.xfinityBlueColor,fillColor:f.xfinityBlueColor});b=a.create({t:"rect",parent:m,x:40,y:c.y+c.h+15,w:m.w-80,lineWidth:1,h:1,lineColor:f.greyColor,fillColor:f.greyColor});var n=a.create({t:"rect",
parent:m,x:40,y:b.y-4,w:b.w/2,lineWidth:2,h:5,lineColor:f.xfinityBlueColor,fillColor:f.xfinityBlueColor}),r=a.create({t:"rect",parent:m,x:40+b.w/2,y:b.y-4,w:b.w/2,lineWidth:2,h:5,lineColor:f.xfinityBlueColor,fillColor:f.xfinityBlueColor});q.draw=!1;g.draw=!1;n.draw=!1;r.draw=!1;this.handleKeys=function(a){switch(a.keyCode){case Keys.ENTER:n.draw?d():r.draw&&e();break;case Keys.RIGHT:n.draw=!1;q.draw=!1;r.draw=!0;g.draw=!0;break;case Keys.LEFT:r.draw=!1,g.draw=!1,n.draw=!0,q.draw=!0}};this.show=function(){m.a=
1};this.hide=function(){m.a=0};this.isVisible=function(){return 1==m.a}};module.exports.DialogItem=DialogItem;
px.import({scene:"px:scene.1.js",keys:"px:tools.keys"}).then(function(a){var b=a.scene,d=a.keys;module.exports.EditBox=function(a){function c(a){console.log("layout( "+a+" ) >>> WxH: "+this._w+" x "+this._h+" at ("+this._x+","+this._y+")")}function e(a,b){G.w=a;G.h=b;z.w=a;R.w=a-2}function m(a){a=z.text.slice().slice(0,a);a=O.measureText(M,a);F.x=a.w-S;0>F.x&&(F.x=1+S);a=4*F.w;var b=R.w-F.x-a,c=Q<=b,d=R.w-a,e=Math.abs(b-Q);Q=b;F.x>d?(c?D<d-a-20&&(D+=e):c||D>a&&(D-=e),I.x=b-D):D=I.x=0}function q(){H=
"";C=B=0;J.x=0;J.w=0}function g(){0>=H.length||(w=w.replace(H,""),z.text="Normal"===u._echoMode?w:E.repeat(w.length),0<C&&(t-=H.length),m(t),q(),K.a=0<z.text.length?0:1)}function n(a,b){var c=a+b;J.a=0===b?0:.75;if(0!==b){0>b&&(c=a,a+=b);H=w.slice().slice(a,c);var d=O.measureText(M,H);J.x=x-S;J.w=d.w+S;0>b&&(J.x-=d.w);t=0<b?c:a;m(t)}}function r(){F.a=0}function v(){F.a=1;l()}function p(){t=0;m(t);q()}function k(){t=z.text.length;m(t);q()}function A(){0===C&&(B=t,x=F.x+S);C+=-t;n(B,C);t=0}function y(){0===
C&&(B=t,x=F.x+S);C+=z.text.length-t;n(B,C);t=z.text.length}function l(){F.animateTo({a:0},.5,b.animation.TWEEN_LINEAR,b.animation.OPTION_OSCILLATE,b.animation.COUNT_FOREVER)}this._x=0;Object.defineProperty(this,"x",{set:function(a){this._x=a;c("setX( "+a+" )")},get:function(){return this._x}});this._y=0;Object.defineProperty(this,"y",{set:function(a){this._y=a;c("setY( "+a+" )")},get:function(){return this._y}});this._w=0;Object.defineProperty(this,"w",{set:function(a){this._w=a;e(this._w,this._h)},
get:function(){return this._w}});this._h=0;Object.defineProperty(this,"h",{set:function(a){this._h=a;e(this._w,this._h)},get:function(){return this._h}});Object.defineProperty(this,"focus",{set:function(a){(z.focus=a)?v():r()},get:function(){return z.focus}});this._keepFocus=!1;Object.defineProperty(this,"keepFocus",{set:function(a){this._keepFocus=a},get:function(){return this._keepFocus}});this._showFocus=!1;Object.defineProperty(this,"showFocus",{set:function(a){this._showFocus=a},get:function(){return this._showFocus}});
Object.defineProperty(this,"interactive",{set:function(a){z.interactive=a;I.interactive=a;console.log(">>> interactive = "+a)},get:function(){return z.interactive}});Object.defineProperty(this,"text",{set:function(a){w=a;z.text="Normal"===u._echoMode?w:E.repeat(w.length);K.a=0<z.text.length?0:1},get:function(){return w.trim()}});Object.defineProperty(this,"onchar",{set:function(a){if("Back"===a){var b=w.slice();0===C?(a=b.slice(0,t-1),b=b.slice(t),w=a+b,z.text="Normal"===u._echoMode?w:E.repeat(w.length),
0<t&&t--):g();K.a=0<z.text.length?0:1}else z.textColor=L,g(),w=w.slice(0,t)+a+w.slice(t),z.text="Normal"===this._echoMode?w:E.repeat(w.length),K.a=0<z.text.length?0:1,t+=1;m(t)}});Object.defineProperty(this,"prompt",{set:function(a){K.text=a},get:function(){return K.text.trim()}});Object.defineProperty(this,"textColor",{set:function(a){z.textColor=a},get:function(){return z.textColor}});this._enableCopy=!0;Object.defineProperty(this,"enableCopy",{set:function(a){this._enableCopy=a},get:function(){return this._enableCopy}});
this._enablePaste=!0;Object.defineProperty(this,"enablePaste",{set:function(a){this._enablePaste=a},get:function(){return this._enablePaste}});this._echoMode="Password";Object.defineProperty(this,"echoMode",{set:function(a){this._echoMode=a;z.text="Normal"===this._echoMode?w:E.repeat(w.length)},get:function(){return this._echoMode}});Object.defineProperty(this,"cursorpos",{set:function(a){t=a},get:function(){return t}});this.moveToHome=p;this.moveToEnd=k;this.selectAll=function(){p();y()};this.clearSelection=
q;this.hideCursor=r;this.showCursor=v;var u=this,w="",t=0,x=0,B=0,C=0,H="",Q=0,D=0,E="\u2022";this._x="x"in a?a.x:0;this._y="y"in a?a.y:0;this._w="w"in a?a.w:200;this._h="h"in a?a.h:50;var M="pts"in a?a.pts:24,V="font"in a?a.font:"FreeSans.ttf",N="prompt_text"in a?a.prompt_text:"Password",P="prompt_color"in a?a.prompt_color:1313754879,W="selection_color"in a?a.selection_color:4243760264,L="text_color"in a?a.text_color:808464639,U="show_focus"in a?a.show_focus:!1,G=b.create({t:"object",parent:"parent"in
a?a.parent:b.root,x:this._x,y:this._y,w:this._w,h:this._h}),R=b.create({t:"object",parent:G,x:0,y:0,w:this._w,h:this._h,clip:!0}),O=b.create({t:"fontResource",url:V}),I=b.create({t:"object",parent:R,x:0,y:0,w:this._w,h:this._h}),T=b.create({t:"rect",w:I.w,h:I.h,parent:I,fillColor:4294967280,x:0,y:0,a:U?.25:0}),K=b.create({t:"text",text:N,font:O,parent:I,pixelSize:M,textColor:P,x:2,y:0}),J=b.create({t:"rect",w:0,h:this._h,parent:I,fillColor:W,x:0,y:0,a:0}),z=b.create({t:"text",text:"",font:O,parent:I,
h:I.h,pixelSize:M,textColor:L,x:2,y:0}),F=b.create({t:"rect",w:2,h:this._h,parent:z,x:0,y:0,fillColor:4294967295,a:0}),S=F.w/2;Promise.all([O,R,K,z,I,F,J]).catch(function(a){console.log(">>> Loading Assets ... err = "+a)}).then(function(a,b){R.interactive=!1;K.interactive=!1;J.interactive=!1;F.interactive=!1;T.interactive=!1;e(u.w,u.h);a=O.measureText(M,"ABCdef123'");z.y=(G.h-a.h)/2;T.h=a.h;T.y=z.y;b=O.measureText(M,z.text);I.w=b.w;J.h=.85*G.h;J.y=(G.h-J.h)/2;F.h=.65*a.h;F.y=(G.h-F.h)/2-z.y;K.y=z.y;
m(0);l()});z.on("onFocus",function(a){v();z.textColor=L});z.on("onBlur",function(a){r()});z.on("onChar",function(a){z.textColor=L;a.charCode!=d.ENTER&&(0!==C&&g(),a.charCode!=d.BACKSPACE&&(g(),w=w.slice(0,t)+String.fromCharCode(a.charCode)+w.slice(t),z.text="Normal"===u._echoMode?w:E.repeat(w.length),K.a=0<z.text.length?0:1,t+=1,m(t)))});z.on("onKeyDown",function(a){var c=a.keyCode;switch(c){case d.BACKSPACE:var e=w.slice();if(0===C){var f=e.slice(0,t-1);e=e.slice(t);w=f+e;z.text="Normal"===u._echoMode?
w:E.repeat(w.length);0<t&&t--}else g();K.a=0<z.text.length?0:1;break;case d.DELETE:e=w.slice();0===C?(f=e.slice(0,t),e=e.slice(t+1),w=f+e,z.text="Normal"===u._echoMode?w:E.repeat(w.length)):g();K.a=0<z.text.length?0:1;break;case d.HOME:u._enableCopy&&d.is_SHIFT(a.flags)?A():p();break;case d.END:u._enableCopy&&d.is_SHIFT(a.flags)?y():k();break;case d.LEFT:if(0===t)break;d.is_CTRL(a.flags)||d.is_CMD(a.flags)?p():u._enableCopy&&(d.is_CTRL_SHIFT(a.flags)||d.is_CMD_SHIFT(a.flags))?A():u._enableCopy&&d.is_SHIFT(a.flags)?
(0===C&&(B=t,x=F.x+S),C--,n(B,C)):(0!==J.w&&q(),t--);break;case d.RIGHT:if(t===z.text.length){console.log("DEBUG:  EDITBOX >> Already at END ! ");break}d.is_CTRL(a.flags)||d.is_CMD(a.flags)?k():u._enableCopy&&(d.is_CTRL_SHIFT(a.flags)||d.is_CMD_SHIFT(a.flags))?y():u._enableCopy&&d.is_SHIFT(a.flags)?(0===C&&(B=t,x=F.x+S),C++,n(B,C)):(0!==J.w&&q(),t++);break;case d.A:u._enableCopy&&(d.is_CTRL(a.flags)||d.is_CMD(a.flags))&&(t=0,x=z.x,B=0,0<z.text.length&&(C=z.text.length+1),n(B,C),a.stopPropagation());
break;case d.C:u._enableCopy&&(d.is_CTRL(a.flags)||d.is_CMD(a.flags))&&b.clipboardSet("PX_CLIP_STRING",H);break;case d.V:u._enablePaste&&(d.is_CTRL(a.flags)||d.is_CMD(a.flags))&&(g(),f=b.clipboardGet("PX_CLIP_STRING"),w=w.slice(0,t)+f+w.slice(t),z.text=w,K.a=0<z.text.length?0:1,F.x=z.x+z.w,t+=f.length,q());break;case d.X:d.is_CTRL(a.flags)&&(b.clipboardSet("PX_CLIP_STRING",H),g())}m(t);c!==d.LEFT&&c!==d.RIGHT||a.stopPropagation()});this.ready=new Promise(function(a,b){Promise.all([K.ready]).then(function(){a()})})}}).catch(function(a){console.error("Import failed for editBox.js: "+
a)});
var HScrollList=function(a,b){function d(){if(0!=n.length)if(0>n[0])if(0>r.x&&0<f){--f;var a=r.x+m[f];r.animateTo({x:a},.2,e.animation.TWEEN_EXP1).then(function(){n.shift();d()},null)}else n.shift();else f<m.length?(a=r.x-m[f],r.animateTo({x:a},.2,e.animation.TWEEN_EXP1).then(function(){f++;n.shift();d()},null)):n.shift()}var e=a;a=global.registry.root;var c=global.registry.all.Utils,f=0,m=[],q=e.create({t:"rect",parent:b.parent,x:b.x,y:b.y,w:b.w,h:b.h,fillColor:c.transparentColor});q.clip=!0;var g,
n=[],r=e.create({t:"rect",parent:q,w:10*a.w,h:q.h,fillColor:c.transparentColor});this.scrollLeft=function(){n.push(-1);1==n.length&&d()};this.scrollRight=function(){n.push(1);1==n.length&&d()};this.addCol=function(a){if(g){if(g.y=0,g.w=q.w,g.h=q.h,r.numChildren){var b=r.getChild(r.numChildren-1).w;g.x+=b;m.push(b)}}else g={x:0,y:0,w:q.w,h:q.h};b=g;a(r,b)};this.clear=function(){r.removeAll();f=m.length=0;g=null;r.x=0}};module.exports.HScrollList=HScrollList;
function Keyboard(a,b){function d(a,b,c){return Math.min(Math.max(b,a),c)}var e=b.keys,c=b.Colors,f=global.registry.baseUrl,m=b.parent,q=b.eventManager,g=this;b=m.w/10;var n=b-10,r=n/2,v=0,p=0,k=null,A={uppercaseAlphabet:{row1:[{x:0,text:"Q"},{x:1*b,text:"W"},{x:2*b,text:"E"},{x:3*b,text:"R"},{x:4*b,text:"T"},{x:5*b,text:"Y"},{x:6*b,text:"U"},{x:7*b,text:"I"},{x:8*b,text:"O"},{x:9*b,text:"P"}],row2:[{x:r,text:"A"},{x:1*b+r,text:"S"},{x:2*b+r,text:"D"},{x:3*b+r,text:"F"},{x:4*b+r,text:"G"},{x:5*b+
r,text:"H"},{x:6*b+r,text:"J"},{x:7*b+r,text:"K"},{x:8*b+r,text:"L"}],row3:[{x:20,w:n+40,text:"SHIFT"},{x:1*b+60,text:"Z"},{x:2*b+60,text:"X"},{x:3*b+60,text:"C"},{x:4*b+60,text:"V"},{x:5*b+60,text:"B"},{x:6*b+60,text:"N"},{x:7*b+60,text:"M"},{x:8*b+60,w:n+30,text:"Back"}],row4:[{x:0,w:n+40,text:"?123"},{x:1*b+40,w:n+40,text:"=\\<"},{x:2*b+80,text:","},{x:3*b+80,w:8*b-30-(3*b+90),text:""},{x:8*b-30,text:"."},{x:9*b-30,w:n+30,text:"Enter"}]},lowercaseAlphabet:{row1:[{x:0,text:"q"},{x:1*b,text:"w"},
{x:2*b,text:"e"},{x:3*b,text:"r"},{x:4*b,text:"t"},{x:5*b,text:"y"},{x:6*b,text:"u"},{x:7*b,text:"i"},{x:8*b,text:"o"},{x:9*b,text:"p"}],row2:[{x:r,text:"a"},{x:1*b+r,text:"s"},{x:2*b+r,text:"d"},{x:3*b+r,text:"f"},{x:4*b+r,text:"g"},{x:5*b+r,text:"h"},{x:6*b+r,text:"j"},{x:7*b+r,text:"k"},{x:8*b+r,text:"l"}],row3:[{x:20,w:n+40,text:"shift"},{x:1*b+60,text:"z"},{x:2*b+60,text:"x"},{x:3*b+60,text:"c"},{x:4*b+60,text:"v"},{x:5*b+60,text:"b"},{x:6*b+60,text:"n"},{x:7*b+60,text:"m"},{x:8*b+60,w:n+30,
text:"Back"}],row4:[{x:0,w:n+40,text:"?123"},{x:1*b+40,w:n+40,text:"=\\<"},{x:2*b+80,text:","},{x:3*b+80,w:8*b-30-(3*b+90),text:""},{x:8*b-30,text:"."},{x:9*b-30,w:n+30,text:"Enter"}]},numeric:{row1:[{x:0,text:"1"},{x:1*b,text:"2"},{x:2*b,text:"3"},{x:3*b,text:"4"},{x:4*b,text:"5"},{x:5*b,text:"6"},{x:6*b,text:"7"},{x:7*b,text:"8"},{x:8*b,text:"9"},{x:9*b,text:"0"}],row2:[{x:0,text:"@"},{x:1*b,text:"#"},{x:2*b,text:"$"},{x:3*b,text:"_"},{x:4*b,text:"&"},{x:5*b,text:"-"},{x:6*b,text:"+"},{x:7*b,text:"("},
{x:8*b,text:")"},{x:9*b,text:"/"}],row3:[{x:100,text:"*"},{x:1*b+100,text:'"'},{x:2*b+100,text:"'"},{x:3*b+100,text:":"},{x:4*b+100,text:";"},{x:5*b+100,text:"!"},{x:6*b+100,text:"?"},{x:7*b+100,w:n+30,text:"Back"}],row4:[{x:0,w:n+40,text:"ABC"},{x:1*b+40,w:n+40,text:"=\\<"},{x:2*b+80,text:","},{x:3*b+80,w:8*b-30-(3*b+90),text:""},{x:8*b-30,text:"."},{x:9*b-30,w:n+30,text:"Enter"}]},symbols:{row1:[{x:0,text:"~"},{x:1*b,text:"`"},{x:2*b,text:"|"},{x:3*b,text:"\u2022"},{x:4*b,text:"\u221a"},{x:5*b,
text:"\u03c0"},{x:6*b,text:"\u00f7"},{x:7*b,text:"x"},{x:8*b,text:"\u00b6"},{x:9*b,text:"\u2206"}],row2:[{x:0,text:"\u20ac"},{x:1*b,text:"\u00a5"},{x:2*b,text:"$"},{x:3*b,text:"\u00a2"},{x:4*b,text:"^"},{x:5*b,text:"\u00b0"},{x:6*b,text:"="},{x:7*b,text:"{"},{x:8*b,text:"}"},{x:9*b,text:"\\"}],row3:[{x:100,text:"%"},{x:1*b+100,text:"\u00a9"},{x:2*b+100,text:"\u2117"},{x:3*b+100,text:"\u2122"},{x:4*b+100,text:"\u221a"},{x:5*b+100,text:"["},{x:6*b+100,text:"]"},{x:7*b+100,w:n+30,text:"Back"}],row4:[{x:0,
w:n+40,text:"ABC"},{x:1*b+40,w:n+40,text:"?123"},{x:2*b+80,text:","},{x:3*b+80,w:8*b-30-(3*b+90),text:""},{x:8*b-30,text:"."},{x:9*b-30,w:n+30,text:"Enter"}]}};this.xfinity_sans_default=a.create({t:"fontResource",url:f+"/fonts/XFINITYSansTT.ttf"});this.defaultResource=a.create({t:"imageResource",w:n,h:100,url:f+"/images/buttonBckground.svg"});this.highlightResource=a.create({t:"imageResource",w:n,h:100,url:f+"/images/buttonHighlight.svg"});this.backResource=a.create({t:"imageResource",w:40,h:40,url:f+
...
this.container=a.create({t:"object",parent:m,w:m.w,h:m.h,interactive:!1});this.updateState=function(b){var d=A[b];b=Object.keys(d);g.container.painting=!1;g.shiftImage.parent=null;k=b.map(function(b,e){b=d[b];var f=65*e,m=b.map(function(b,d){var B=b.x,m=b.w?b.w:n,t=a.stretch.STRETCH,l=a.stretch.STRETCH;if(k&&k[e]&&k[e][1][d]){var x=k[e][1][d][0];d=k[e][1][d][1];x.x=B;x.y=f;x.w=m;x.stretchX=t;x.stretchY=l;d.w=m;d.text=b.text;2==e&&"shift"==b.text?(d.a=0,g.shiftImage.parent=x,g.shiftImage.x=x.w/2-20,
g.shiftImage.y=x.h/2-17.5,g.shiftImage.resource=g.shiftResource):2==e&&"SHIFT"==b.text?(d.a=0,g.shiftImage.parent=x,g.shiftImage.x=x.w/2-20,g.shiftImage.y=x.h/2-17.5,g.shiftImage.resource=g.shiftFillResource):2==e&&"Back"==b.text?(d.a=0,g.backImage.parent=x,g.backImage.x=x.w/2-20,g.backImage.y=x.h/2-20):3==e&&"Enter"==b.text?(d.a=0,g.enterImage.parent=x,g.enterImage.x=x.w/2-30,g.enterImage.y=x.h/2-15):d.a=1}else x=a.create({t:"image9",insetLeft:5,insetTop:5,insetRight:5,insetBottom:5,parent:g.container,
x:B,y:f,w:m,h:50,resource:g.defaultResource}),d=a.create({t:"textBox",parent:x,textColor:c.WHITE,w:x.w,h:x.h,pixelSize:25,text:b.text,font:g.xfinity_sans_default,alignHorizontal:a.alignHorizontal.CENTER,alignVertical:a.alignVertical.CENTER}),2==e&&"SHIFT"==b.text?(d.a=0,g.shiftImage.parent=x,g.shiftImage.x=x.w/2-20,g.shiftImage.y=x.h/2-17.5,g.shiftImage.resource=g.shiftFillResource):2==e&&"shift"==b.text?(d.a=0,g.shiftImage.parent=x,g.shiftImage.x=x.w/2-20,g.shiftImage.y=x.h/2-17.5,g.shiftImage.resource=
g.shiftResource):2==e&&"Back"==b.text?(d.a=0,g.backImage.parent=x,g.backImage.x=x.w/2-20,g.backImage.y=x.h/2-20):3==e&&"Enter"==b.text&&(d.a=0,g.enterImage.parent=x,g.enterImage.x=x.w/2-30,g.enterImage.y=x.h/2-15);return[x,d]});if(k&&k[e])for(var B=m.length;B<k[e][0];B++)k[e][1][B][0].remove(),k[e][1][B][1].remove();return[b.length,m]});g.container.painting=!0};this.container.on("onKeyDown",function(a){var b=v,c=p;a.keyCode===e.DOWN?(b=d(v+1,0,3),c=d(p,0,k[b][0]-1)):a.keyCode===e.UP?(b=d(v-1,0,3),
c=d(p,0,k[b][0]-1)):a.keyCode===e.LEFT?(c=d(p-1,0,k[v][0]-1),a.stopPropagation()):a.keyCode===e.RIGHT&&(c=d(p+1,0,k[v][0]-1));if(b!=v||c!=p)k[v][1][p][0].resource=g.defaultResource,v=b,p=c,k[v][1][p][0].resource=g.highlightResource,a.stopPropagation()});this.container.on("onKeyUp",function(a){if(a.keyCode===e.ENTER){var b=k[v][1][p][1].text;"shift"===b?g.updateState("uppercaseAlphabet"):"SHIFT"===b?g.updateState("lowercaseAlphabet"):"ABC"===b?g.updateState("uppercaseAlphabet"):"?123"===b?g.updateState("numeric"):
"=\\<"===b?g.updateState("symbols"):q.fireEvent("onkeyPressed",b);a.stopPropagation()}});Object.defineProperty(this,"focus",{set:function(a){g.container.focus=a;k[v][1][p][0].resource=a?g.highlightResource:g.defaultResource},get:function(){return g.container.focus}});this.updateState("lowercaseAlphabet")}module.exports.Keyboard=Keyboard;
function NetworkDetails(a,b){var d=this,e=b.keys,c=b.Colors,f=b.baseUrl,m=b.parent,q=a.root,g=b._owner,n=a.alignHorizontal.CENTER,r=a.alignVertical.CENTER,v=a.animation.TWEEN_EXP1,p=a.animation.OPTION_FASTFORWARD,k=a.create({t:"fontResource",url:f+"/fonts/XFINITYSansTT.ttf"}),A=a.create({t:"fontResource",url:f+"/fonts/XFINITYSansTT-Medium.ttf"}),y=a.create({t:"imageResource",w:b.w,h:b.h,url:f+"/images/popBackground.svg"}),l=a.create({t:"imageResource",w:130,h:40,url:f+"/images/buttonBckground.svg"}),
u=a.create({t:"imageResource",w:130,h:40,url:f+"/images/buttonHighlight.svg"});this.device=b.device;this.ready=new Promise(function(f,t){Promise.all([y.ready,l.ready,u.ready]).then(function(){d.popupParent=a.create({t:"image",parent:q,w:b.w,h:b.h,x:b.x,y:b.y,interactive:!1,a:.95,sx:0,sy:0,cx:b.cx,cy:b.cy,resource:y,stretchX:a.stretch.STRETCH,stretchY:a.stretch.STRETCH});d.margine=a.create({t:"rect",parent:d.popupParent,fillColor:c.WHITE,w:d.popupParent.w,h:2,y:70,a:.3});d.title=a.create({t:"textBox",
parent:d.popupParent,textColor:c.WHITE,w:d.popupParent.w,font:A,h:40,y:16,pixelSize:35,text:b.title,alignHorizontal:n,alignVertical:r});d.description=a.create({t:"textBox",parent:d.popupParent,textColor:c.WHITE,wordWrap:!0,font:k,w:d.popupParent.w-100,h:150,x:50,y:80,pixelSize:27,text:b.description});d.cancelParent=a.create({t:"image9",parent:d.popupParent,w:130,h:40,x:60,y:b.h-70,cx:65,cy:20,resource:l});d.cancelText=a.create({t:"textBox",parent:d.cancelParent,textColor:c.WHITE,w:d.cancelParent.w,
font:k,h:d.cancelParent.h,pixelSize:25,text:"Cancel",alignHorizontal:n,alignVertical:r});d.modifyParent=a.create({t:"image9",parent:d.popupParent,w:130,h:40,x:240,y:b.h-70,cx:65,cy:20,resource:l});d.modifyText=a.create({t:"textBox",parent:d.modifyParent,textColor:c.WHITE,w:d.modifyParent.w,font:k,h:d.modifyParent.h,pixelSize:25,text:"Modify",alignHorizontal:n,alignVertical:r});d.forgetParent=a.create({t:"image9",parent:d.popupParent,w:130,h:40,x:d.popupParent.w-180,y:d.popupParent.h-70,cx:65,cy:20,
resource:l});d.forgetText=a.create({t:"textBox",parent:d.forgetParent,textColor:c.WHITE,text:"Forget",font:k,w:d.forgetParent.w,h:d.forgetParent.h,pixelSize:25,alignHorizontal:n,alignVertical:r});d.cancelParent.on("onKeyDown",function(a){a.keyCode==e.RIGHT&&(d.modifyParent.focus=!0,d.modifyParent.resource=u,d.cancelParent.resource=l);a.stopPropagation()});d.cancelParent.on("onKeyUp",function(a){a.keyCode==e.ENTER&&(m.onPopupClose(),d.cancelParent.animateTo({sx:1.3,sy:1.3},.1,v,p,1).then(function(){d.cancelParent.animateTo({sx:1,
sy:1},.1,v,p,1)}),d.hide());a.stopPropagation()});d.modifyParent.on("onKeyDown",function(a){var b=a.keyCode;b==e.RIGHT?(d.forgetParent.focus=!0,d.forgetParent.resource=u,d.modifyParent.resource=l):b==e.LEFT&&(d.cancelParent.focus=!0,d.cancelParent.resource=u,d.modifyParent.resource=l);a.stopPropagation()});d.modifyParent.on("onKeyUp",function(a){a.keyCode==e.ENTER&&(m.onPopupClose(),d.modifyParent.animateTo({sx:1.3,sy:1.3},.1,v,p,1).then(function(){d.modifyParent.animateTo({sx:1,sy:1},.1,v,p,1)}),
d.hide());a.stopPropagation()});d.forgetParent.on("onKeyDown",function(a){a.keyCode==e.LEFT&&(d.modifyParent.focus=!0,d.modifyParent.resource=u,d.forgetParent.resource=l);a.stopPropagation()});d.forgetParent.on("onKeyUp",function(a){a.keyCode==e.ENTER&&(m.onPopupClose(),d.forgetParent.animateTo({sx:1.3,sy:1.3},.1,v,p,1).then(function(){d.forgetParent.animateTo({sx:1,sy:1},.1,v,p,1)}),g.fireEvent("onclearSSID"),d.hide());a.stopPropagation()});d.show=function(){var b=this;this.popupParent.animateTo({x:a.w/
2-this.popupParent.w/2,y:a.h/2-this.popupParent.h/2,sx:1,sy:1,a:.95},.3,v,p,1).then(function(a){b.popupParent.cx=b.popupParent.w/2;b.popupParent.cy=b.popupParent.h/2});this.cancelParent.focus=!0;this.cancelParent.resource=u};d.hide=function(){this.popupParent.animateTo({sx:2,sy:2,a:0},.3,a.animation.TWEEN_LINEAR,p,1).then(function(a){})};d.setFocus=function(){this.forgetParent.resource=l;this.modifyParent.resource=l;this.cancelParent.focus=!0;this.cancelParent.resource=u};f("sucess")}).catch(function(a){console.log("Promise failed in popup",
a);t(Error("Promise failed"))})})}module.exports.NetworkDetails=NetworkDetails;
function Popup(a,b){var d=this,e=b.keys,c=b.Colors,f=b.isDetailsPopup?b.isDetailsPopup:0,m=b.baseUrl,q=f?130:60,g=b._owner,n=b.parent,r=a.root,v=a.alignHorizontal.CENTER,p=a.alignVertical.CENTER,k=a.animation.TWEEN_EXP1,A=a.animation.OPTION_FASTFORWARD,y=a.create({t:"fontResource",url:m+"/fonts/XFINITYSansTT.ttf"}),l=a.create({t:"imageResource",w:b.w,h:b.h,url:m+"/images/popBackground.svg"}),u=a.create({t:"imageResource",w:q,h:40,url:m+"/images/buttonBckground.svg"}),w=a.create({t:"imageResource",
w:q,h:40,url:m+"/images/buttonHighlight.svg"}),t=a.create({t:"imageResource",w:35,h:35,url:m+"/images/volumeIcon.svg"}),x=a.create({t:"imageResource",w:25,h:25,url:m+"/images/whiteCircleHolo.svg"}),B=a.create({t:"imageResource",w:25,h:25,url:m+"/images/highlightCircle.svg"});this.device=b.device;this.isLoudSpeaker=this.device.deviceType.match(/LOUDSPEAKER/i);this.ready=new Promise(function(m,H){Promise.all([l.ready,u.ready,w.ready]).then(function(){d.popupParent=a.create({t:"image",parent:r,w:b.w,
h:b.h,x:b.x,y:b.y,interactive:!1,a:.95,sx:0,sy:0,cx:b.cx,cy:b.cy,resource:l,stretchX:a.stretch.STRETCH,stretchY:a.stretch.STRETCH});d.margine=a.create({t:"rect",parent:d.popupParent,fillColor:c.WHITE,w:d.popupParent.w,h:2,y:70,a:.3});d.title=a.create({t:"textBox",parent:d.popupParent,textColor:c.WHITE,w:d.popupParent.w,font:y,h:40,y:16,pixelSize:35,text:b.title,alignHorizontal:v,alignVertical:p});d.description=a.create({t:"textBox",parent:d.popupParent,textColor:c.WHITE,wordWrap:!0,font:y,w:d.popupParent.w-
100,h:150,x:50,y:80,pixelSize:27,text:b.description});d.volumeObject=a.create({t:"object",parent:d.popupParent,w:200,h:70,x:50,y:120,resource:t,a:d.isLoudSpeaker?1:0});d.volumeIcon=a.create({t:"image9",parent:d.volumeObject,w:35,h:35,resource:t});d.volumeDownIcon=a.create({t:"image9",parent:d.volumeObject,w:25,h:25,cx:12.5,cy:12.5,x:50,y:5,resource:x});d.volumeDownText=a.create({t:"textBox",parent:d.volumeObject,w:25,h:25,x:50,y:-6,pixelSize:20,textColor:c.WHITE,font:y,text:"_",alignHorizontal:a.alignHorizontal.CENTER,
alignVertical:a.alignVertical.TOP});d.volumeUpIcon=a.create({t:"image9",parent:d.volumeObject,w:25,h:25,cx:12.5,cy:12.5,x:85,y:5,resource:x});d.volumeUpText=a.create({t:"textBox",parent:d.volumeObject,w:25,h:25,x:85,y:2,pixelSize:20,textColor:c.WHITE,font:y,text:"+",alignHorizontal:a.alignHorizontal.CENTER,alignVertical:a.alignVertical.CENTER});d.yesParent=a.create({t:"image9",parent:d.popupParent,w:q,h:40,x:b.isDetailsPopup?60:b.w/2-q-30,y:b.h-70,cx:q/2,cy:20,resource:u});d.yesText=a.create({t:"textBox",
parent:d.yesParent,textColor:c.WHITE,w:d.yesParent.w,font:y,h:d.yesParent.h,pixelSize:25,text:b.yes.text,alignHorizontal:v,alignVertical:p});d.noParent=a.create({t:"image9",parent:d.popupParent,w:q,h:40,x:f?240:b.w/2+30,y:b.h-70,cx:q/2,cy:20,resource:u});d.noText=a.create({t:"textBox",parent:d.noParent,textColor:c.WHITE,w:d.noParent.w,font:y,h:d.noParent.h,pixelSize:25,text:b.no.text,alignHorizontal:v,alignVertical:p});d.cancelParent=a.create({t:"image9",parent:d.popupParent,w:q,h:40,a:f,x:d.popupParent.w-
180,y:d.popupParent.h-70,cx:q/2,cy:20,resource:u});d.cancelText=a.create({t:"textBox",parent:d.cancelParent,textColor:c.WHITE,text:"Cancel",font:y,w:d.cancelParent.w,h:d.cancelParent.h,pixelSize:25,alignHorizontal:v,alignVertical:p});d.volumeDownIcon.on("onKeyDown",function(a){var b=a.keyCode;b==e.DOWN?(d.yesParent.focus=!0,d.yesParent.resource=w,d.volumeDownIcon.resource=x):b==e.RIGHT&&(d.volumeUpIcon.focus=!0,d.volumeUpIcon.resource=B,d.volumeDownIcon.resource=x);a.stopPropagation()});d.volumeDownIcon.on("onKeyUp",
function(a){a.keyCode==e.ENTER&&(d.volumeDownIcon.animateTo({sx:1.3,sy:1.3},.1,k,A,1).then(function(){d.volumeDownIcon.animateTo({sx:1,sy:1},.1,k,A,1)}),a.device=d.device,g.fireEvent("scr_onVolumeDown",a));a.stopPropagation()});d.volumeUpIcon.on("onKeyDown",function(a){var b=a.keyCode;b==e.DOWN?(d.yesParent.focus=!0,d.yesParent.resource=w,d.volumeUpIcon.resource=x):b==e.LEFT&&(d.volumeDownIcon.focus=!0,d.volumeDownIcon.resource=B,d.volumeUpIcon.resource=x);a.stopPropagation()});d.volumeUpIcon.on("onKeyUp",
function(a){a.keyCode==e.ENTER&&(d.volumeUpIcon.animateTo({sx:1.3,sy:1.3},.1,k,A,1).then(function(){d.volumeUpIcon.animateTo({sx:1,sy:1},.1,k,A,1)}),a.device=d.device,g.fireEvent("scr_onVolumeUp",a));a.stopPropagation()});d.yesParent.on("onKeyDown",function(a){var b=a.keyCode;b==e.RIGHT?(d.noParent.focus=!0,d.noParent.resource=w,d.yesParent.resource=u):b==e.UP&&d.isLoudSpeaker&&(d.volumeDownIcon.focus=!0,d.volumeDownIcon.resource=B,d.yesParent.resource=u);a.stopPropagation()});d.yesParent.on("onKeyUp",
function(a){a.keyCode==e.ENTER&&(n.onPopupClose(),d.yesParent.animateTo({sx:1.3,sy:1.3},.1,k,A,1).then(function(){d.yesParent.animateTo({sx:1,sy:1},.1,k,A,1)}),"Pairing Request"==d.title.text?(a.device=d.device,g.fireEvent("scr_onPairingAccept",a)):"Connection Request"==d.title.text?(a.device=d.device,g.fireEvent("scr_onConnectionAccept",a)):"Bluetooth Device Settings"==d.title.text&&(a.device=d.device,a.device&&a.device.connected?g.fireEvent("onDeviceDisconnect",a):g.fireEvent("scr_onDeviceSelected",
a)),d.hide());a.stopPropagation()});d.noParent.on("onKeyDown",function(a){var b=a.keyCode;b==e.RIGHT&&f?(d.cancelParent.focus=!0,d.cancelParent.resource=w,d.noParent.resource=u):b==e.LEFT?(d.yesParent.focus=!0,d.yesParent.resource=w,d.noParent.resource=u):b==e.UP&&d.isLoudSpeaker&&(d.volumeDownIcon.focus=!0,d.volumeDownIcon.resource=B,d.noParent.resource=u);a.stopPropagation()});d.noParent.on("onKeyUp",function(a){a.keyCode==e.ENTER&&(n.onPopupClose(),d.noParent.animateTo({sx:1.3,sy:1.3},.1,k,A,1).then(function(){d.noParent.animateTo({sx:1,
sy:1},.1,k,A,1)}),"Pairing Request"==d.title.text?(a.device=d.device,g.fireEvent("scr_onPairingDecline",a)):"Connection Request"==d.title.text?(a.device=d.device,g.fireEvent("scr_onConnectionDecline",a)):"Bluetooth Device Settings"==d.title.text&&(a.device=d.device,a.device&&a.device.paired?g.fireEvent("onDeviceUnpair",a):g.fireEvent("scr_onDeviceSelected",a)),d.hide());a.stopPropagation()});d.cancelParent.on("onKeyDown",function(a){var b=a.keyCode;b==e.LEFT?(d.noParent.focus=!0,d.noParent.resource=
w,d.cancelParent.resource=u):b==e.UP&&d.isLoudSpeaker&&(d.volumeDownIcon.focus=!0,d.volumeDownIcon.resource=B,d.cancelParent.resource=u);a.stopPropagation()});d.cancelParent.on("onKeyUp",function(a){a.keyCode==e.ENTER&&(n.onPopupClose(),d.cancelParent.animateTo({sx:1.3,sy:1.3},.1,k,A,1).then(function(){d.cancelParent.animateTo({sx:1,sy:1},.1,k,A,1)}),d.hide());a.stopPropagation()});d.show=function(){var b=this;this.popupParent.animateTo({x:a.w/2-this.popupParent.w/2,y:a.h/2-this.popupParent.h/2,sx:1,
sy:1,a:.95},.3,k,A,1).then(function(a){b.popupParent.cx=b.popupParent.w/2;b.popupParent.cy=b.popupParent.h/2});this.yesParent.focus=!0;this.yesParent.resource=w};d.hide=function(){this.popupParent.animateTo({sx:2,sy:2,a:0},.3,a.animation.TWEEN_LINEAR,A,1).then(function(a){})};d.setFocus=function(){this.cancelParent.resource=u;this.noParent.resource=u;this.yesParent.focus=!0;this.yesParent.resource=w};m("sucess")}).catch(function(a){console.log("Promise failed in popup",a);H(Error("Promise failed"))})})}
module.exports.Popup=Popup;
var TabContainer=function(a,b){function d(a){try{var b=q.create({t:"fontResource",url:k+"/fonts/DejaVuSans.ttf"}),c=q.create({t:"rect",parent:v,x:a.x,y:a.y,w:a.w,h:a.h,fillColor:Colors.BLACK,a:0,sx:0,sy:0,cx:a.w/2,cy:a.h/2,lineColor:Colors.BLACK,lineWidth:2});q.create({t:"textBox",parent:c,textColor:r.headerTextColor,font:b,w:c.w,h:c.h,pixelSize:40,text:a.message,alignHorizontal:q.alignHorizontal.CENTER,alignVertical:q.alignVertical.CENTER});c.animateTo({sx:1,sy:1,a:1},.3,q.animation.TWEEN_EXP1,q.animation.OPTION_FASTFORWARD,
1).then(setTimeout(function(){c.animateTo({y:h,a:0},.3,q.animation.TWEEN_EXP1,q.animation.OPTION_FASTFORWARD,1).then(setTimeout(function(){c.remove();c=null},5E3))},2E3))}catch(H){console.log("caught exception in reboot box"),console.log(H)}}var e=global.registry.all.TabView,c=global.registry.all.HScrollList,f=[],m=0,q=a,g=global.registry.root,n=global.registry.keyCodes;a=global.registry.all.Utils;var r=b,v=r.parent,p=0,k=global.registry.baseUrl,A=null,y=0,l=0;var u=new global.registry.all.DialogItem(q,
{title:"Reboot Confirmation",mainText:"Do you want to continue with reboot of device?"},function(){var a=q.getService("systemService");a.setApiVersionNumber(11);a.callMethod("reboot")},function(){u.hide()});u.hide();var w=q.create({t:"rect",parent:v,lineWidth:1,h:1,lineColor:a.greyColor,fillColor:a.greyColor});w.y=r.y+r.headerFont.measureText(r.headerPixelSize,"test text").h+30;b=q.create({t:"rect",parent:v,x:20,y:w.y+w.h+10,w:g.w-40,h:g.h-w.y-w.h-10,fillColor:a.transparentColor});var t=new c(q,{parent:b,
x:0,y:0,w:b.w,h:b.h});this.addTab=function(a,b){var c={};c.title=a.title;c.parent=v;c.headerFont=r.headerFont;c.headerPixelSize=r.headerPixelSize;c.headerY=r.y;c.headerTextColor=r.headerTextColor;c.headerHighlightedColor=r.headerHighlightedColor;c.bodyParent=t;b=new e(c,b);f.push(b);p&&(p+=r.headerGap);p+=r.headerFont.measureText(r.headerPixelSize,a.title).w;a=(v.w-p)/2;for(c=0;c<f.length;c++)f[c].setHeaderPos({x:a}),a+=r.headerFont.measureText(r.headerPixelSize,f[c].getHeaderText()).w,a+=r.headerGap;
w.x=(v.w-p-r.headerGap)/2;w.w=p+r.headerGap;return b};this.selectTab=function(a){f[a].select();m=a};g.on("onPreKeyDown",function(a){switch(a.keyCode){case n.ENTER:null==A&&(A=setTimeout(function(){if(1E3>Date.now()-l)try{d({message:"Rebooting.....",w:300,h:100,x:(g.w-250)/2,y:(g.h-120)/2});var a=global.registry.scene.getService("systemService");if(a){a.setApiVersionNumber(17);var b=a.callMethod("reboot",'{"params": ["Restarting STB from Spark Diagnostics"]}');!1===JSON.parse(b).success&&console.log("Reboot Failed!")}else console.log("unable to initialize system_15 service to get device details")}catch(H){console.log("caught exception in reboot box"),
console.log(H)}},5E3)),0==l?l=Date.now():(y=Date.now(),1E3<y-l?(clearTimeout(A),A=null,y=l=0):l=y)}});g.on("onKeyDown",function(a){if(u.isVisible())u.handleKeys(a);else{switch(a.keyCode){case n.UP:f[m].scrollUp();break;case n.DOWN:f[m].scrollDown();break;case n.LEFT:if(0<m){m--;for(var b=0;b<f.length;b++)b==m?f[b].select():f[b].unselect();t.scrollLeft()}a.stopPropagation();break;case n.RIGHT:if(m<f.length-1){m++;for(b=0;b<f.length;b++)b==m?f[b].select():f[b].unselect();t.scrollRight()}a.stopPropagation()}a.stopPropagation()}})};
module.exports.TabContainer=TabContainer;
var TabView=function(a,b){var d=global.registry.all.Utils,e=global.registry.all.VScrollList,c=a.parent,f=d.scene,m,q=f.create({t:"text",parent:c,y:a.headerY,w:160,h:25,text:a.title,font:a.headerFont,pixelSize:a.headerPixelSize,alignHorizontal:f.alignHorizontal.CENTER,textColor:a.headerTextColor}),g=f.create({t:"rect",parent:c,y:q.y+q.h+26,w:a.headerFont.measureText(a.headerPixelSize,a.title).w+40,lineWidth:2,h:5,lineColor:d.xfinityBlueColor,fillColor:d.xfinityBlueColor}),n=g.draw=!1,r;q.on("onMouseEnter",
function(b){q.textColor=a.headerHighlightedColor;g.draw=!0});q.on("onMouseLeave",function(b){n||(q.textColor=a.headerTextColor,g.draw=!1)});a.bodyParent.addCol(function(a,c){m=new e(d.scene,{parent:a,x:c.x,y:c.y,w:c.w,h:c.h});b.show(m)});this.select=function(){n=!0;q.textColor=a.headerHighlightedColor;g.draw=!0;q.focus=!0;b.refresh();b.isBluetoothScreen||(r=setInterval(b.refresh,3E4))};this.unselect=function(){n=!1;q.textColor=a.headerTextColor;g.draw=!1;void 0!==r&&clearInterval(r)};this.scrollUp=
function(){m.scrollUp()};this.scrollDown=function(){m.scrollDown()};this.setHeaderPos=function(a){q.x=a.x;g.x=q.x-20};this.getHeaderText=function(){return a.title}};module.exports.TabView=TabView;var packagePath=px.getPackageBaseFilePath();packagePath+="/modules/";px.configImport({"module:":packagePath});
...
"PX051ANI";a.isClientDevice=!1;a.isClientNoMocaDevice=!1;a.doHttpPost=function(a,e){console.log("Inside Utils.doHttpPost");return new Promise(function(c,d){var f=b.request(a,function(a){a.setEncoding("utf8");var b="";a.on("data",function(a){b+=a});a.on("end",function(a){c(JSON.parse(b))})});f.on("error",function(b){console.log("Error: FAILED from web service ["+a.hostname+":"+a.port+"]. "+b.message);d("HTTP ERROR "+b.message)});f.write(e);f.end();console.log("After post inside Utils.doHttpPost")})};
module.exports.Utils=a}).catch(function(a){console.error("Import failed for Utils.js: "+a)});
var VScrollList=function(a,b){function d(){var a=r.getChild(r.numChildren-1);return m[f]*q.h/(a.y+a.h)}function e(){if(0!=n.length)if(0>n[0])if(0>r.y&&0<f){--f;var a=r.y+m[f];r.animateTo({y:a},.2,c.animation.TWEEN_EXP1).then(function(){n.shift();e()},null);v.y-=d()}else n.shift();else f<m.length?(a=r.y-m[f],r.animateTo({y:a},.2,c.animation.TWEEN_EXP1).then(function(){f++;n.shift();e()},null),v.y+=d()):n.shift()}var c=a;a=global.registry.all.Utils;var f=0,m=[],q=c.create({t:"rect",parent:b.parent,
x:b.x,y:b.y,w:b.w,h:b.h,fillColor:a.transparentColor});q.clip=!0;var g,n=[],r=c.create({t:"rect",parent:q,w:q.w,h:5E3,fillColor:a.transparentColor}),v=c.create({t:"rect",parent:q,x:r.w-12,y:0,w:7,h:150,a:0,fillColor:a.coolGrey11Color});this.scrollUp=function(){n.push(-1);1==n.length&&e()};this.scrollDown=function(){n.push(1);1==n.length&&e()};this.addRow=function(a){if(g){g.x=0;g.w=q.w;if(r.numChildren){var b=r.getChild(r.numChildren-1).h;g.y+=b;m.push(b)}g.h=100}else g={x:0,y:0,w:q.w,h:100};b=g;
a(r,b);g.y+g.h>q.h&&(v.a=1);a=r.getChild(r.numChildren-1);a.x&&(b=r.getChild(r.numChildren-2),a.h>b.h?b.h=a.h:a.h=b.h)};this.clear=function(){r.removeAll();f=m.length=0;g=null;v.y=0;r.y=0}};module.exports.VScrollList=VScrollList;
...
function BtConnectivityScreen(a,b){function d(){this.createUI=function(a){this.device=a.device;this.animate=400>a.y;this.getDeviceIcon=function(){if(this.device.deviceType.match(/LOUDSPEAKER/i))return z;if(a.name.match(/keyboard/i))return K;a.name.match(/mouse/i);return J};this.itemRoot=f.create({t:"rect",parent:a.parent,x:0,y:a.y,w:a.w,h:a.h,fillColor:a.fillColor,a:this.animate?0:1,sx:this.animate?.5:1,sy:this.animate?.5:1,cx:a.w/2,cy:a.h/2});this.deviceTypeImageBG=f.create({t:"image",parent:this.itemRoot,
w:40,h:40,x:20,y:10,resource:F});this.deviceTypeImage=f.create({t:"image",parent:this.deviceTypeImageBG,w:30,h:30,x:5,y:5,resource:this.getDeviceIcon(),stretchX:f.stretch.STRETCH,stretchY:f.stretch.STRETCH});this.deviceName=f.create({t:"textBox",parent:this.itemRoot,textColor:g.TEXT,font:D,w:this.itemRoot.w,h:this.itemRoot.h,x:80,pixelSize:25,text:a.name,alignHorizontal:u,alignVertical:t});this.deviceNameMargineLine=f.create({t:"rect",parent:this.itemRoot,w:this.itemRoot.w,h:2,y:this.itemRoot.h-2,
fillColor:g.BLACK,a:.3});this.moreOptions=f.create({t:"object",parent:this.itemRoot,w:40,h:40,x:this.itemRoot.w-50,y:this.itemRoot.h/2-20,cx:20,cy:20});this.rightImage=f.create({t:"image",parent:this.moreOptions,w:this.moreOptions.w,h:this.moreOptions.h,resource:I});this.status=f.create({t:"textBox",parent:this.itemRoot,textColor:g.STATUS_COLOR,font:D,w:300,h:this.itemRoot.h,x:this.itemRoot.w-370,pixelSize:25,text:this.device.connected?"CONNECTED":this.device.paired?"PAIRED":"",alignHorizontal:w,
alignVertical:t});return this.animate?this.itemRoot.animateTo({sx:1,sy:1,a:1},.3,C,B,1):new Promise(function(a,b){a("sucess")})};this.y=function(){return this.itemRoot.y};this.selectItem=function(a){a?(this.itemRoot.fillColor=g.LIST_HIGHLIGHT,this.deviceName.textColor=g.WHITE):(this.itemRoot.fillColor=g.LIST_NORMAL,this.deviceName.textColor=g.TEXT);this.rightImage.resource=I};this.updateStatus=function(a){var b=this;this.status.text=a;setTimeout(function(){b.status.text=b.device.connected?"CONNECTED":
b.device.paired?"PAIRED":""},3E4)};this.selectMoreOptions=function(a){a?(this.itemRoot.fillColor=g.LIST_NORMAL,this.deviceName.textColor=g.TEXT,this.rightImage.resource=T):this.rightImage.resource=I};this.isMoreOptionsSelected=function(){return this.rightImage.resource==T?!0:!1};this.click=function(a){var b=this;if(this.rightImage.resource==T){this.moreOptions.animateTo({sx:1.3,sy:1.3},.1,x,B,1).then(function(){b.moreOptions.animateTo({sx:1,sy:1},.1,x,B,1)});var c=new q(f,{parent:Q,_owner:y,keys:m,
baseUrl:n,Colors:g,device:this.device,title:"Bluetooth Device Settings",description:this.deviceName.text,w:600,h:250,isDetailsPopup:1,x:this.itemRoot.x+10+20,y:this.itemRoot.y+G.y+290,cx:0,cy:0,yes:{text:this.device.connected?"Disconnect":"Connect"},no:{text:this.device.paired?"Unpair":"Pair"}});c.ready.then(function(){k.push(c);c.show()}).catch(function(a){console.log(a)})}else this.device.connected||(a.device=this.device,this.updateStatus(this.device.paired?"CONNECTING...":"PAIRING..."),setTimeout(function(){y.fireEvent("scr_onDeviceSelected",
a)},100))}}function e(){if(p.length!=A.length){var a=p.length,b=A[a],c=b.name,f=new d;p.push(f);f.createUI({parent:G,y:60*a,w:L.w,h:60,fillColor:g.LIST_NORMAL,name:c,device:b}).then(function(){e()}).catch(function(a){console.log("promise failed in populateItem")})}}function c(a){var b=p[a],c=-G.y;v=a;0<=r&&p[r].selectItem(!1);p[v].selectItem(!0);r=v;b.y()<c?(c=-b.y(),G.animateTo({y:c},.1,C,H,1)):b.y()+60-L.h>c&&(c=-(b.y()+60-L.h),G.animateTo({y:c},.1,C,H,1))}var f=a,m=b.keys,q=b.Popup,g=b.Colors,
n=px.getPackageBaseFilePath(),r=-1,v=-1,p=[],k=[],A=[],y=b.context,l=b.parent;b=f.alignHorizontal.CENTER;var u=f.alignHorizontal.LEFT,w=f.alignHorizontal.RIGHT,t=f.alignVertical.CENTER,x=f.animation.TWEEN_EXP1,B=f.animation.OPTION_FASTFORWARD,C=f.animation.TWEEN_LINEAR,H=f.animation.OPTION_LOOP,Q=this,D=f.create({t:"fontResource",url:n+"/fonts/XFINITYSansTT.ttf"});this.onPopulateDevices=function(a){A=a;p.length=0;G.y=0;r=v=-1;O.hide();0==A.length?(G.removeAll(),R.a=0,0===k.length&&(P.focus=!0,N.resource=
V),U&&U.animateTo({sx:1,sy:1,a:1},.3,x,B,1)):(0===k.length&&(P.focus=!1,N.resource=M,G.focus=!0),U&&U.animateTo({sx:0,sy:0,a:0},.3,x,B,1),R.a=.3,G.removeAll(),e(),c(0))};this.onPairingRequest=function(a){var b=new q(f,{parent:Q,_owner:y,keys:m,baseUrl:n,Colors:g,title:"Pairing Request",device:a.device,description:'Do you want to pair and connect "'+a.device.name+'"\n\nPIN: '+a.device.pinValue,w:600,h:300,x:l.w/2-300,y:l.h/2-150,cx:300,cy:150,yes:{text:"Yes"},no:{text:"No"}});b.ready.then(function(){k.push(b);
b.show()}).catch(function(a){console.log(a)})};this.onConnectionRequest=function(a){var b=new q(f,{parent:Q,_owner:y,keys:m,baseUrl:n,Colors:g,title:"Connection Request",device:a.device,description:'Do you want connect "'+a.device.name+'"',w:600,h:250,x:l.w/2-300,y:l.h/2-125,cx:300,cy:125,yes:{text:"Yes"},no:{text:"No"}});b.ready.then(function(){k.push(b);b.show()}).catch(function(a){console.log(a)})};this.onStartDiscovery=function(){O.show()};this.onError=function(){O.hide()};this.onPopupClose=function(){k.pop();
var a=k.length;0<a?k[a-1].setFocus():G.focus=!0};var E=f.create({t:"object",parent:l,w:l.w,h:l.h,interactive:!1});f.create({t:"textBox",parent:E,textColor:g.TEXT,x:15,y:20,w:650,h:40,pixelSize:28,text:"Xfinity Bluetooth Settings",cx:325,cy:20,font:D,alignHorizontal:u,alignVertical:t});a=f.create({t:"object",parent:E,w:350,h:f.h-250,x:800,y:80});var M=f.create({t:"imageResource",url:n+"/images/refreshNetwork.svg",w:350,h:50}),V=f.create({t:"imageResource",url:n+"/images/refreshNetworkHL.svg",w:350,
h:50}),N=f.create({t:"image",parent:a,w:350,h:50,x:0,y:a.h-100,resource:M}),P=f.create({t:"textBox",parent:N,textColor:g.WHITE,w:N.w,h:N.h,pixelSize:28,text:"Discover new devices",alignHorizontal:b,alignVertical:t,font:D,cx:N.w/2,cy:N.h/2}),W=f.create({t:"imageResource",url:n+"/images/bluetoothSignal.svg",w:120,h:120});f.create({t:"image",parent:a,w:120,h:120,x:a.w/2-60,y:80,resource:W});f.create({t:"textBox",parent:a,textColor:g.WHITE,x:a.w/2-150,y:200,w:300,h:40,pixelSize:24,text:"Now discoverable as",
font:D,alignHorizontal:b});f.create({t:"textBox",parent:a,textColor:g.WHITE,x:a.w/2-150,y:230,w:300,h:40,pixelSize:24,text:'"Xfinity Bluetooth"',font:D,alignHorizontal:b});E=f.create({t:"rect",parent:E,w:650,h:f.h-250,x:15,y:80,fillColor:g.LISTPARENT,interactive:!1});f.create({t:"textBox",parent:E,textColor:g.HEADER,x:20,y:20,w:630,h:40,pixelSize:28,text:"Manage Bluetooth devices",font:D,alignHorizontal:u,alignVertical:t});var L=f.create({t:"object",parent:E,x:0,y:80,w:E.w,h:E.h-80,clip:!0}),U=f.create({t:"textBox",
parent:L,textColor:g.TEXT,x:0,y:-80,w:L.w,h:L.h,pixelSize:25,text:"No Bluetooth devices found.",alignHorizontal:b,alignVertical:t,cx:L.w/2,cy:L.h/2,font:D}),G=f.create({t:"object",parent:L}),R=f.create({t:"rect",parent:E,w:L.w,h:2,y:78,fillColor:g.BLACK,a:0});b=f.create({t:"imageResource",url:n+"/images/loadingIndicator.svg",w:50,h:50});var O={image:f.create({t:"image",parent:a,w:50,h:50,x:a.w/2-25,y:a.h-180,cx:25,cy:25,resource:b,a:0,stretchX:f.stretch.STRETCH,stretchY:f.stretch.STRETCH}),animate:null,
show:function(){this.animate&&(this.animate.cancel(),this.animate=null);this.image.a=1;this.animate=this.image.animate({r:360},1.5,f.animation.TWEEN_LINEAR,f.animation.OPTION_REWIND,f.animation.COUNT_FOREVER)},hide:function(){this.animate&&(this.animate.cancel(),this.animate=null);this.image.a=0}},I=f.create({t:"imageResource",w:40,h:40,url:n+"/images/moreOptions.svg"}),T=f.create({t:"imageResource",w:40,h:40,url:n+"/images/moreOptionsHL.svg"});f.create({t:"imageResource",w:40,h:40,url:n+"/images/smokecircle.svg"});
f.create({t:"imageResource",w:30,h:30,url:n+"/images/phone.png"});var K=f.create({t:"imageResource",w:30,h:30,url:n+"/images/keyboard.svg"}),J=f.create({t:"imageResource",w:30,h:30,url:n+"/images/mouse.svg"});f.create({t:"imageResource",w:30,h:30,url:n+"/images/paired.png"});f.create({t:"imageResource",w:30,h:30,url:n+"/images/connected.png"});var z=f.create({t:"imageResource",w:30,h:30,url:n+"/images/headset.svg"}),F=f.create({t:"imageResource",w:40,h:40,url:n+"/images/imageBG.svg"});G.on("onKeyDown",
function(a){var b=a.keyCode,d=p.length;b==m.UP?(c(Math.min(Math.max(0,v-1),d-1)),a.stopPropagation()):b==m.DOWN?(v===d-1?(p[v].selectItem(!1),N.resource=V,P.focus=!0):c(Math.min(Math.max(0,v+1),d-1)),a.stopPropagation()):b==m.LEFT?0<=v&&v<d&&p[v].isMoreOptionsSelected()&&(p[v].selectItem(!0),a.stopPropagation()):b==m.RIGHT?0<=v&&v<d&&(p[v].isMoreOptionsSelected()?(p[v].selectItem(!1),N.resource=V,P.focus=!0):p[v].selectMoreOptions(!0),a.stopPropagation()):b==m.ENTER&&a.stopPropagation()});G.on("onKeyUp",
function(a){var b=p.length;a.keyCode==m.ENTER&&(0<=v&&v<b&&p[v].click(a),a.stopPropagation(),console.log("on item click"+v))});P.on("onKeyDown",function(a){var b=a.keyCode;b==m.UP||b==m.LEFT?(p[v].selectItem(!0),N.resource=M,G.focus=!0,a.stopPropagation()):b==m.ENTER&&(P.animateTo({sx:1.1,sy:1.1},.1,x,B,1).then(function(){P.animateTo({sx:1,sy:1},.1,x,B,1)}),a.stopPropagation(),console.log("discoverNewDevices event"))});P.on("onKeyUp",function(a){a.keyCode==m.ENTER&&(y.fireEvent("scr_onStartDiscovery",
a),a.stopPropagation(),console.log("discoverNewDevices event"))});P.focus=!0}module.exports.BtConnectivityScreen=BtConnectivityScreen;
var BtConnectivityView=function(){function a(){this.show=function(a){var c=this;this.toastRoot=b.create({t:"rect",parent:p,x:p.w/2-a.w/2,y:p.h-100,w:a.w,h:a.h,fillColor:f.TALL_POPPY,a:0,sx:0,sy:0,cx:a.w/2,cy:a.h/2,lineColor:f.WHITE,lineWidth:2});this.deviceName=b.create({t:"textBox",parent:this.toastRoot,textColor:f.WHITE,font:y,w:this.toastRoot.w,h:this.toastRoot.h,pixelSize:25,text:a.message,alignHorizontal:b.alignHorizontal.CENTER,alignVertical:b.alignVertical.CENTER});this.toastRoot.animateTo({sx:1,
sy:1,a:1},.3,b.animation.TWEEN_EXP1,b.animation.OPTION_FASTFORWARD,1).then(setTimeout(function(){c.toastRoot.animateTo({y:p.h,a:0},.3,b.animation.TWEEN_EXP1,b.animation.OPTION_FASTFORWARD,1).then(setTimeout(function(){c.toastRoot.remove();c.toastRoot=null},1E3))},2E3))}}var b=global.registry.scene,d=global.registry.all.BaseEventManager,e=global.registry.all.Options,c=global.registry.all.BtUtils,f=global.registry.all.Colors,m=global.registry.all.Logger,q=global.registry.all.EmulatorWindow,g=global.registry.all.Bluetooth,
n=global.registry.all.BtConnectivityScreen,r=global.registry.all.Popup,v=global.registry.keyCodes,p=null,k=null,A=px.getPackageBaseFilePath(),y=b.create({t:"fontResource",url:A+"/fonts/XFINITYSansTT.ttf"});console.time("App start");console.time("Startup action");var l={user_accepted_pairing:!1,known_devices:null,discovered_devices:null,paired_devices:null,connected_devices:null,_owner:null,_actions:new Map,_aip:!1,_aip_handler:null,_aip_timeout:30,_aip_timer_id:null,populateDevices:function(){var a=
...
this._owner.log("Nothing to clear.")},setOwner:function(a){if("null"===a||"object"!==typeof a)return!1;this._owner=a;return!0},setTimeOutHandler:function(a,b){if("null"===this._owner||"object"!==typeof this._owner||"null"===a||"function"!==typeof a||1>b)return!1;this._aip_handler=a;this._aip_timeout=b;return!0}};Object.defineProperties(l,{action_in_progress:{get:function(){return 0<this._actions.size},set:function(a){var b=this;a=!!a;this._owner.log("%s action.",a?"Starting":"Stopping");this._aip_timer_id&&
clearTimeout(this._aip_timer_id);a&&0<this._aip_timeout&&null!==this._aip_handler&&null!==this._owner&&"function"===typeof this._aip_handler&&"object"===typeof this._owner&&(this._aip_timer_id=setTimeout(function(){b._aip_handler.apply(b._owner,arguments)},1E3*this._aip_timeout))}}});var u={__proto__:Object.create(d.prototype),name:"Bluetooth Settings",screen:null,identity:{name:"app",version:"1.0.8.12",marker:{left:"{ ",right:" } "}},_options:{emulation:!1,debug:!1},api:null,_payload:{},availableDevicesTimer:null,
...
run:function(){this.log("Getting support status.");var a=this.api.getStatusSupport();this.log("Status: %s",JSON.stringify(a));this.log("Enabling bluetooth.");a=this.api.enable();this.log("Result: %s",JSON.stringify(a));this.log("Making STB discoverable.");a=this.api.setBluetoothDiscoverable("on");this.log("Status: %s",JSON.stringify(a));this.fireEvent("onStartingUp",{});this.log("%s is ready.",this.isEmulation()?"Emulation":"Hardware")},showEmulator:function(){q.init({owner:this,parent:p});q.setupUI(b)},
isEmulation:function(){return c.parseBool(this._options.emulation)},isDebug:function(){return c.parseBool(this._options.debug)},resetAvailableDevicesTimer:function(){var a=this;this.availableDevicesTimer&&clearTimeout(this.availableDevicesTimer);this.availableDevicesTimer=setTimeout(function(){var b=l.discovered_devices&&0<l.discovered_devices.size;l.discovered_devices=null;b&&(l.populateDevices(),a.updateSceneDetails("populateDevices"))},18E4)},updateSceneDetails:function(a,b){switch(a){case "populateDevices":if(l.known_devices)k.onPopulateDevices(Array.from(l.known_devices.values()));
break;case "pairingRequest":k.onPairingRequest(b);break;case "connectionRequest":k.onConnectionRequest(b)}},_handleTimeOut:function(){this.log("Operation is timed out.");l.clearActions();c.sprintf("Device did not respond in %s seconds",l._aip_timeout);k.onError();(new a).show({message:"Device did not respond in "+l._aip_timeout+" seconds",w:600,h:50})},getData:function(){return this._payload}};d.call(u);m.call(Object.getPrototypeOf(u));u.api_event_listeners.set("statusChanged",function(a){this.log("API event: statusChanged.");
this.log(JSON.stringify(a));switch(a.newStatus){case "DISCOVERY_COMPLETED":this.fireEvent("onDiscoveryCompleted",a);break;case "PAIRING_CHANGE":this.fireEvent("onPairingChange",a);break;case "CONNECTION_CHANGE":this.fireEvent("onConnectionChange",a);break;case "SOFTWARE_ENABLED":this.fireEvent("onSoftwareEnabled",a);break;case "SOFTWARE_DISABLED":this.fireEvent("onSoftwareDisabled",a)}});u.api_event_listeners.set("requestFailed",function(a){this.log("API event: requestFailed.");this.log(JSON.stringify(a));
switch(a.newStatus){case "PAIRING_FAILED":this.fireEvent("onPairingFailed",a);break;case "CONNECTION_FAILED":this.fireEvent("onConnectionFailed",a)}});u.api_event_listeners.set("pairingRequest",function(a){this.log("API event: pairingRequest.");this.log(JSON.stringify(a));this.fireEvent("onPairingRequest",a)});u.api_event_listeners.set("connectionRequest",function(a){this.log("API event: connectionRequest.");this.log(JSON.stringify(a));this.fireEvent("onConnectionRequest",a)});u.api_event_listeners.set("deviceFound",
function(a){this.log("API event: deviceFound.");this.log(JSON.stringify(a));this.fireEvent("onDeviceFound",a)});u.api_event_listeners.set("deviceLost",function(a){this.log("API event: deviceLost.");this.log(JSON.stringify(a));this.fireEvent("onDeviceLost",a)});u.event_listeners.set("onStartingUp",function(a){this.log("Handling onStartingUp event.");l.paired_devices=l._owner.api.getPairedDevices(["HUMAN INTERFACE DEVICE","LOUDSPEAKER"]);l.connected_devices=l._owner.api.getConnectedDevices(["HUMAN INTERFACE DEVICE",
"LOUDSPEAKER"]);l.populateDevices();console.timeEnd("Startup action");this.log("Handling onStartingUp event: done.")});u.event_listeners.set("onDiscoveryCompleted",function(a){this.log("Handling onDiscoveryCompleted event.");l.stopAction("discovery");this.log("Getting discovered HUMAN INTERFACE DEVICES.");a=this.api.getDiscoveredDevices(["HUMAN INTERFACE DEVICE","LOUDSPEAKER"]);this.log("Status: %s",JSON.stringify(a));l.discovered_devices=new Map;a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=
a.next())b=b.value,l.discovered_devices.has(b.deviceID)||(l.discovered_devices.set(b.deviceID,b),this.log("Device %s added to known devices",b.name));l.populateDevices();this.updateSceneDetails("populateDevices");this.log("Handling onDiscoveryCompleted event: done.");this.resetAvailableDevicesTimer()});u.event_listeners.set("onPairingRequest",function(a){this.log("Handling onPairingRequest event.");this.log("Got a pairing request from %s",JSON.stringify(a));this.updateSceneDetails("pairingRequest",
{device:a});this.log("Handling onPairingRequest event: done.")});u.event_listeners.set("onPairingChange",function(a){this.log("Handling onPairingChange event.");l.hasAction("pairing")&&l.stopAction("pairing");l.paired_devices=l._owner.api.getPairedDevices(["HUMAN INTERFACE DEVICE","LOUDSPEAKER"]);l.populateDevices();this.updateSceneDetails("populateDevices");this.log("Handling onPairingChange event: done.")});u.event_listeners.set("onConnectionRequest",function(a){this.log("Handling onConnectionRequest event.");
this.log("Got a connection request from %s",JSON.stringify(a));this.api.respondToEvent({eventType:"connectionRequest",responseValue:"ACCEPTED",deviceID:a.deviceID});this.log("Handling onConnectionRequest event: done.")});u.event_listeners.set("onConnectionChange",function(a){l.connected_devices=l._owner.api.getConnectedDevices(["HUMAN INTERFACE DEVICE","LOUDSPEAKER"]);l.populateDevices();this.updateSceneDetails("populateDevices")});u.event_listeners.set("onConnectionFailed",function(b){this.log("Handling onConnectionFailed event.");
this.log("Connection failed: %s",JSON.stringify(b));(new a).show({message:"Connection request was refused by STB",w:600,h:50});this.log("Handling onConnectionFailed event: done.")});u.event_listeners.set("onPairingFailed",function(b){this.log("Handling onPairingFailed event.");this.log("Pairing failed: %s",JSON.stringify(b));l.hasAction("pairing")&&l.stopAction("pairing");(new a).show({message:"Pairing request was refused by STB",w:600,h:50});this.log("Handling onPairingFailed event: done.")});u.event_listeners.set("onDeviceFound",
function(b){this.log("Handling onDeviceFound event.");this.log("Doing nothing.");this.log("Handling onDeviceFound event: done.");(new a).show({message:"onDeviceFound",w:600,h:50})});u.event_listeners.set("onDeviceLost",function(b){this.log("Handling onDeviceLost event.");this.log("Doing nothing.");this.log("Handling onDeviceLost event: done.");(new a).show({message:"onDeviceLost",w:600,h:50})});var w=function(a){this.log("Handling onDisconnect event.");this.log("Handling onDisconnect event: done.")};
u.event_listeners.set("scr_onDeviceSelected",function(a){this.log("scr_onDeviceSelected ",l.action_in_progress);if(!l.action_in_progress){this.log("Looking whether %s is already connected.",a.device.name);for(var b=$jscomp.makeIterator(l.paired_devices),c=b.next();!c.done;c=b.next())if(c.value.deviceID===a.device.deviceID){this.log("%s is paired. Proceeding to the connection request screen.",a.device.name);this.api.setDeviceConnection(a.device.deviceID,"CONNECT",a.device.deviceType);return}this.log("%s is not paired. Proceeding to the pairing request screen.",
a.device.name);l.startAction("pairing",{device:a.device});this.api.setDevicePairing(a.device.deviceID,!0)}});u.event_listeners.set("onDeviceUnpair",function(a){this.log("onDeviceUnpair ",l.action_in_progress);!l.action_in_progress&&a.device&&(l.startAction("pairing",{device:a.device}),a.device.connected&&this.api.setDeviceConnection(a.device.deviceID,"DISCONNECT",a.device.deviceType),this.api.setDevicePairing(a.device.deviceID,!1))});u.event_listeners.set("onDeviceDisconnect",function(a){this.log("onDeviceDisconnect");
a.device&&this.api.setDeviceConnection(a.device.deviceID,"DISCONNECT",a.device.deviceType)});u.event_listeners.set("scr_onStartDiscovery",function(a){this.log("scr_onStartDiscovery call ",l.action_in_progress);l.action_in_progress||(l.startAction("discovery"),this.log("Discovery requested."),this.log("Starting device discovery."),k.onStartDiscovery(),a=this.api.startDeviceDiscovery(20),this.log("Status: %s",JSON.stringify(a)))});u.event_listeners.set("scr_onPairingAccept",function(a){this.log("scr_onPairingAccept ",
l.action_in_progress);l.action_in_progress||(this.log("Device accepted %s",JSON.stringify(a.device)),l.user_accepted_pairing=!0,l.startAction("pairing",{device:a.device}),this.api.respondToEvent({eventType:"pairingRequest",responseValue:"ACCEPTED",name:a.device.name,mac:a.device.MAC,deviceID:a.device.deviceID}))});u.event_listeners.set("scr_onPairingDecline",function(b){this.log("scr_onPairingDecline ",l.action_in_progress);l.action_in_progress||(this.log("Device declined"),this.api.respondToEvent({eventType:"pairingRequest",
responseValue:"REJECTED",name:b.device.name,mac:b.device.MAC,deviceID:b.device.deviceID}),(new a).show({message:"User did not accept the pairing request",w:600,h:50}))});u.event_listeners.set("scr_onConnectionAccept",function(a){this.log("scr_onConnectionAccept ",l.action_in_progress);l.action_in_progress?this.log("Connection request can't be accepted: There is one or more actions in progress: %s",l._actions):(this.log("Device accepted %s",JSON.stringify(a.device)),this.log("Accepting connection from %s",
a.device.name),this.api.respondToEvent({eventType:"connectionRequest",responseValue:"ACCEPTED",name:a.device.name,mac:a.device.MAC,deviceID:a.device.deviceID}))});u.event_listeners.set("scr_onConnectionDecline",function(b){this.log("scr_onConnectionDecline ",l.action_in_progress);l.action_in_progress||(this.log("Device declined"),this.api.respondToEvent({eventType:"connectionRequest",responseValue:"REJECTED",name:b.device.name,mac:b.device.MAC,deviceID:b.device.deviceID}),(new a).show({message:"User did not accept the connection request",
w:600,h:50}))});u.event_listeners.set("scr_onDisconnect",function(a){w.apply(this,arguments)});u.event_listeners.set("scr_onClose",function(a){this.log("scr_onClose ")});u.event_listeners.set("scr_onVolumeDown",function(a){this.api.setPlayback(a.device.deviceID,"VOULUME_DOWN")});u.event_listeners.set("scr_onVolumeUp",function(a){this.api.setPlayback(a.device.deviceID,"VOLUME_UP")});this.isBluetoothScreen=!0;this.setService=function(a){u.init({service:a,api_version:4,emulation:e.emulation?e.emulation:
"on",debug:e.debug?e.debug:"on"});u.run()};this.show=function(a){a.clear();a.addRow(function(a,c){c.h=580;p=b.create({t:"object",parent:a,w:c.w,h:c.h,x:c.x,y:c.y,fillColor:f.WHITE});k=new n(b,{BaseEventManager:d,keys:v,Popup:r,Colors:f,context:u,parent:p});u.isEmulation()&&u.showEmulator()})};this.refresh=function(){u.updateSceneDetails("populateDevices")};console.timeEnd("App start")};module.exports.BtConnectivityView=BtConnectivityView;
...
var CableCardView=function(){var a=global.registry.all.Utils,b=global.registry.all.HdmiStatus,d=global.registry.all.VodStatus,e=[];this.show=function(c){c.clear();c.addRow(function(a,c){c.h=240;a=new b({title:"HDMI",parent:a,x:c.x,y:c.y,w:c.w,h:c.h});e.push(a.updateData);a.show()});c.addRow(function(b,c){c.h=!1===a.isClientDevice?560:460;1==a.isClientNoMocaDevice&&(c.h=540);var d=new d({title:"A/V",parent:b,x:c.x,y:c.y,w:c.w,h:c.h});e.push(d.updateData);d.show()});c.addRow(function(a,b){b.h=300;a=
new d({title:"VOD",parent:a,x:b.x,y:b.y,w:b.w,h:b.h});e.push(a.updateData);a.show()})};this.refresh=function(){for(var a=0;a<e.length;a++)e[a]()}};module.exports.CableCardView=CableCardView;
...
var DeviceLocalStatus=function(a){var b=global.registry.all.DetailsItem,d=global.registry.all.Utils,e={};this.show=function(){var c=new b(d.scene,a);c.setSeparatorPlacement(.3);1==d.isClientDevice?(1==d.isClientNoMocaDevice?(e["Device.WiFi.SSID.1.Status"]=c.addRow("WiFi Status","TODO"),e["Device.WiFi.SSID.1.MACAddress"]=c.addRow("WiFi MAC","TODO"),e["Device.WiFi.SSID.1.Name"]=c.addRow("SSID","TODO"),e["Device.WiFi.Radio.1.OperatingFrequencyBand"]=c.addRow("Frequency","TODO"),e["Device.WiFi.Radio.1.Channel"]=
...
function(){var f=new b(d.scene,a);f.setSeparatorPlacement(.4);f.addRow("Make",e.get(d.modelName));c["Device.DeviceInfo.ModelName"]=f.addRow("Model","TODO");c["Device.DeviceInfo.SerialNumber"]=f.addRow("Serial Number","TODO");c["Device.DeviceInfo.X_COMCAST-COM_STB_MAC"]=f.addRow("eSTB Mac (Device/Mgmt)","TODO");1==d.isClientDevice&&(1==d.isClientNoMocaDevice?(c["Device.WiFi.SSID.1.MACAddress"]=f.addRow("WiFi Mac","TODO"),c["Device.Ethernet.Interface.1.MACAddress"]=f.addRow("Ethernet Mac","TODO")):
c["Device.MoCA.Interface.1.MACAddress"]=f.addRow("MoCA Mac","TODO"));c["Device.X_COMCAST-COM_Xcalibur.Client.XRE.xreReceiverId"]=f.addRow("Receiver ID",d.placeHolderWrapText,!0);c["Device.DeviceInfo.HardwareVersion"]=f.addRow("HW Rev","TODO");c["Device.DeviceInfo.UpTime"]=f.addRow("Uptime","TODO");c["Device.DeviceInfo.X_COMCAST-COM_PowerStatus"]=f.addRow("Power Status","TODO");c["Device.DeviceInfo.X_RDKCENTRAL-COM.BootStatus"]=f.addRow("Boot Status","XRE connection established - successful")};this.updateData=
function(){console.log("devicestatus updateData");d.doHttpPost({hostname:"127.0.0.1",port:10999,method:"POST",headers:{"Content-Type":"application/json"}},'{"paramList" : [               {"name" : "Device.DeviceInfo.ModelName"},               {"name" : "Device.DeviceInfo.SerialNumber"},               {"name" : "Device.DeviceInfo.X_COMCAST-COM_STB_MAC"},               {"name" : "Device.X_COMCAST-COM_Xcalibur.TRM.trmGatewaySTBMAC"},               {"name" : "Device.MoCA.Interface.1.MACAddress"},               {"name" : "Device.DeviceInfo.HardwareVersion"},               {"name" : "Device.DeviceInfo.UpTime"},               {"name" : "Device.WiFi.SSID.1.MACAddress"},               {"name" : "Device.Ethernet.Interface.1.MACAddress"},               {"name" : "Device.DeviceInfo.X_COMCAST-COM_PowerStatus"},               {"name" : "Device.DeviceInfo.X_RDKCENTRAL-COM.BootStatus"},               {"name" : "Device.X_COMCAST-COM_Xcalibur.Client.XRE.xreReceiverId"}               ]}').then(function(a){for(var b=
...
var InitHistoryStatus=function(a){var b=global.registry.all.Utils,d={};this.show=function(){new DetailsItem(b.scene,a)};this.updateData=function(){var a={hostname:"127.0.0.1",port:10999,method:"POST",headers:{"Content-Type":"application/json"}};b.doHttpPost(a,'{"paramList" : [               {"name" : "Device.X_COMCAST-COM_Xcalibur.Client.XRE.InitHistoryStatus"}               ]}').then(function(a){console.log("got successful response from tr69 service");console.log("parse value is "+a.paramList[0].value);
for(var b=0;b<a.paramList.length;b++)d[a.paramList[b].name].text=a.paramList[b].value},function(b){console.log("inside errorCallback");console.log("Error: FAILED from web service ["+a.hostname+":"+a.port+"]")})}};module.exports.InitHistoryStatus=InitHistoryStatus;
var InstallSummaryView=function(){var a=global.registry.all.Utils,b=global.registry.all.DeviceStatus,d=global.registry.all.NetworkConnection,e=global.registry.all.FirmwareStatus,c=global.registry.all.XreStatus,f=global.registry.all.TunerStatus,m=global.registry.all.MemoryStatus,q=global.registry.all.InitHistoryStatus,g=global.registry.all.HostTru2WayStatus,n=global.registry.all.HostPropertiesStatus,r=global.registry.all.MCardCertificateStatus,v=global.registry.all.WifiStatus,p=[];this.show=function(k){k.addRow(function(a,
c){c.w/=2;var e=new b({title:"Device Status",parent:a,x:c.x,y:c.y,w:c.w,h:c.h});p.push(e.updateData);e.show();c.x=c.w;a=new d({title:"Network Connection",parent:a,x:c.x,y:c.y,w:c.w,h:c.h});p.push(a.updateData);a.show()});k.addRow(function(a,b){b.w/=2;var d=new e({title:"Firmware",parent:a,x:b.x,y:b.y,w:b.w,h:b.h});p.push(d.updateData);d.show();b.x=b.w;a=new c({title:"XRE",parent:a,x:b.x,y:b.y,w:b.w,h:b.h});p.push(a.updateData);a.show()});k.addRow(function(a,b){b.w/=2;var c=new f({title:"Tuner Status",
parent:a,x:b.x,y:b.y,w:b.w,h:b.h});p.push(c.updateData);c.show();b.x=b.w;a=new m({title:"Memory",parent:a,x:b.x,y:b.y,w:b.w,h:b.h});p.push(a.updateData);a.show()});1==a.isClientNoMocaDevice&&k.addRow(function(a,b){a=new v({title:"WIFI Stats",parent:a,x:b.x,y:b.y,w:b.w,h:b.h});p.push(a.updateData);a.show()});0==a.isClientDevice&&(k.addRow(function(a,b){b.w/=2;var c=new q({title:"Init History",parent:a,x:b.x,y:b.y,w:b.w,h:b.h});p.push(c.updateData);c.show();b.x=b.w;a=new g({title:"Host: Tru2Way",parent:a,
x:b.x,y:b.y,w:b.w,h:b.h});p.push(a.updateData);a.show()}),k.addRow(function(a,b){b.w/=2;var c=new n({title:"Host: Properties",parent:a,x:b.x,y:b.y,w:b.w,h:b.h});p.push(c.updateData);c.show();b.x=b.w;var d=new d({title:"Cable Card",parent:a,x:b.x,y:b.y,w:b.w,h:b.h});p.push(d.updateData);d.show()}),k.addRow(function(a,b){a=new r({title:"M-Card Certificate",parent:a,x:b.x,y:b.y,w:b.w,h:b.h});p.push(a.updateData);a.show()}))};this.refresh=function(){for(var a=0;a<p.length;a++)p[a]()}};
...
var NetworkConnection=function(a){var b=global.registry.all.DetailsItem,d=global.registry.all.Utils,e={};this.show=function(){var c=new b(d.scene,a);c.setSeparatorPlacement(.4);e["Device.DeviceInfo.X_COMCAST-COM_STB_IP"]=c.addRow("eSTB IP","TODO");0==d.isClientNoMocaDevice&&(e["Device.MoCA.Interface.1.Status"]=c.addRow("MoCA Status","TODO"),e["Device.MoCA.Interface.1.AssociatedDeviceNumberOfEntries"]=c.addRow("# of Connected Devices","TODO"),e["Device.MoCA.Interface.1.NodeID"]=c.addRow("Node ID",
"TODO"),e["Device.X_COMCAST-COM_Xcalibur.TRM.trmGatewayDeviceFriendlyName"]=c.addRow("NC Name","TODO"),e["Device.X_COMCAST-COM_Xcalibur.TRM.trmGatewaySTBMAC"]=c.addRow("NC MoCA MAC","TODO"),e["Device.MoCA.Interface.1.AssociatedDevice.1.PHYTxRate"]=c.addRow("NC Tx/Rx Rates","TODO"));1==d.isClientDevice&&(1==d.isClientNoMocaDevice&&(c.addRow("Ethernet Status","TODO"),c.addRow("Ethernet LinkLocal IPv4","TODO"),c.addRow("Ethernet DHCP IPv4","TODO"),c.addRow("Ethernet LinkLocal IPv6","TODO"),c.addRow("Ethernet GloballyUnique IPv6",
...
var NetworkConnection_1=function(a){var b=global.registry.all.DetailsItem,d=global.registry.all.Utils,e={};this.show=function(){var c=new b(d.scene,a);c.setSeparatorPlacement(.4);1==d.isClientNoMocaDevice?(e["Device.WiFi.SSID.1.Status"]=c.addRow("WiFi Status","TODO"),c.addRow("Ethernet Status","TODO"),c.addRow("Ethernet LinkLocal IP","TODO"),c.addRow("Ethernet DHCP IP","TODO"),c.addRow("WiFi LinkLocal IP","TODO"),c.addRow("WiFi DHCP IP","TODO")):(e["Device.MoCA.Interface.1.Status"]=c.addRow("MoCA Status",
...
var NetworkConnectionsView=function(){var a=global.registry.all.Utils,b=global.registry.all.DeviceLocalStatus,d=global.registry.all.NetworkConnection,e=global.registry.all.DocsisStatus,c=global.registry.all.DocsisLevelsStatus,f=global.registry.all.InBandNetworkStatus,m=global.registry.all.ErrorsNetworkStatus,q=global.registry.all.FlowsInUseStatus,g=global.registry.all.DsgStatus,n=global.registry.all.TunnelInfoScreenStatus,r=global.registry.all.MCardCahnStatus,v=global.registry.all.CanhStatus2,p=global.registry.all.CanhStatus3,
k=global.registry.all.CanhStatus4,A=global.registry.all.CanhStatus5,y=global.registry.all.CanhStatus6,l=global.registry.all.OperationalStatus,u=global.registry.all.WifiStatus,w=[];this.show=function(t){t.clear();t.addRow(function(a,c){c.w/=2;var e=new b({title:"Device Local",parent:a,x:c.x,y:c.y,w:c.w,h:c.h});w.push(e.updateData);e.show();c.x=c.w;a=new d({title:"Network Connection",parent:a,x:c.x,y:c.y,w:c.w,h:c.h});w.push(a.updateData);a.show()});1==a.isClientNoMocaDevice&&t.addRow(function(a,b){a=
new u({title:"WIFI Stats",parent:a,x:b.x,y:b.y,w:b.w,h:b.h});w.push(a.updateData);a.show()});0==a.isClientDevice&&(t.addRow(function(a,b){b.w/=2;var d=new e({title:"DOCSIS",parent:a,x:b.x,y:b.y,w:b.w,h:b.h});w.push(d.updateData);d.show();b.x=b.w;a=new c({title:"DOCSIS Levels",parent:a,x:b.x,y:b.y,w:b.w,h:b.h});w.push(a.updateData);a.show()}),t.addRow(function(a,b){b.w/=2;var c=new f({title:"In-Band Network",parent:a,x:b.x,y:b.y,w:b.w,h:b.h});w.push(c.updateData);c.show();b.x=b.w;a=new m({title:"Errors",
parent:a,x:b.x,y:b.y,w:b.w,h:b.h});w.push(a.updateData);a.show()}),t.addRow(function(a,b){b.w/=2;var c=new q({title:"Flows in Use",parent:a,x:b.x,y:b.y,w:b.w,h:b.h});w.push(c.updateData);c.show();b.x=b.w;a=new g({title:"DSG",parent:a,x:b.x,y:b.y,w:b.w,h:b.h});w.push(a.updateData);a.show()}),t.addRow(function(a,b){b.w/=2;var c=new n({title:"Tunnel Info Screen 1",parent:a,x:b.x,y:b.y,w:b.w,h:b.h});w.push(c.updateData);c.show();b.x=b.w;a=new r({title:"MCARD CAHN Status 1",parent:a,x:b.x,y:b.y,w:b.w,
h:b.h});w.push(a.updateData);a.show()}),t.addRow(function(a,b){b.w/=2;var c=new v({title:"CANH Status 2",parent:a,x:b.x,y:b.y,w:b.w,h:b.h});w.push(c.updateData);c.show();b.x=b.w;a=new p({title:"CANH Status 3",parent:a,x:b.x,y:b.y,w:b.w,h:b.h});w.push(a.updateData);a.show()}),t.addRow(function(a,b){b.w/=2;var c=new k({title:"CANH Status 4",parent:a,x:b.x,y:b.y,w:b.w,h:b.h});w.push(c.updateData);c.show();b.x=b.w;a=new A({title:"CANH Status 5",parent:a,x:b.x,y:b.y,w:b.w,h:b.h});w.push(a.updateData);
a.show()}),t.addRow(function(a,b){b.w/=2;var c=new y({title:"CANH Status 6",parent:a,x:b.x,y:b.y,w:b.w,h:b.h});w.push(c.updateData);c.show();b.x=b.w;a=new l({title:"Operational Status",parent:a,x:b.x,y:b.y,w:b.w,h:b.h});w.push(a.updateData);a.show()}))};this.refresh=function(){for(var a=0;a<w.length;a++)w[a]()}};module.exports.NetworkConnectionsView=NetworkConnectionsView;
...
function WifiPassword(a,b){var d=b.keys,e=b.Colors,c=b.device,f=b.EditBox,m=b.Keyboard,q=b.eventManager;b=b.parent;var g=this,n=null,r=a.alignHorizontal.CENTER,v=a.alignVertical.CENTER,p=global.registry.baseUrl;this.xfinity_sans_default=a.create({t:"fontResource",url:p+"/fonts/XFINITYSansTT.ttf"});this.container=a.create({t:"rect",parent:b,w:b.w,h:b.h,fillColor:808464639,interactive:!1});this.title=a.create({t:"textBox",parent:this.container,textColor:e.WHITE,x:a.w/2-150,y:0,w:300,h:40,pixelSize:28,
text:"Wi-Fi password",font:this.xfinity_sans_default,alignHorizontal:r,alignVertical:v});this.subTitle=a.create({t:"textBox",parent:this.container,textColor:e.WHITE,x:a.w/2-200,y:this.title.y+50,w:400,h:30,pixelSize:20,text:"Enter the password for "+c.ssid,font:this.xfinity_sans_default,alignHorizontal:r,alignVertical:v,a:.8});this.subTitle1=a.create({t:"rect",parent:this.container,x:a.w/2-200,y:this.subTitle.y+35,w:400,h:50,lineWidth:4,lineColor:e.BACKGROUND1,fillColor:e.TRANSPARENT});this.inputBox=
new f({parent:this.subTitle1,x:5,w:this.subTitle1.w-10,h:this.subTitle1.h,pts:30,text_color:4294967295,font:p+"/fonts/XFINITYSansTT.ttf"});this.checkbox=a.create({t:"rect",parent:this.container,x:this.subTitle1.x,y:this.subTitle1.y+60,w:30,h:30,lineWidth:4,lineColor:e.BACKGROUND1,fillColor:e.TRANSPARENT});this.checkResource=a.create({t:"imageResource",w:16,h:16,url:p+"/images/check.svg"});this.checkImage=a.create({t:"image",parent:this.checkbox,w:this.checkbox.w,h:this.checkbox.h,x:7,y:7,resource:this.checkResource,
a:0});this.showPasswordText=a.create({t:"textBox",parent:this.container,textColor:e.WHITE,x:this.checkbox.x+40,y:this.subTitle1.y+60,w:400,h:30,pixelSize:20,text:"Show password",font:this.xfinity_sans_default,alignVertical:v});this.cancelRect=a.create({t:"rect",parent:this.container,x:this.subTitle1.x+this.subTitle1.w-220,y:this.subTitle1.y+110,w:100,h:40,fillColor:e.BTNBACKGROUND});this.cancelText=a.create({t:"textBox",parent:this.cancelRect,textColor:e.WHITE,w:this.cancelRect.w,h:this.cancelRect.h,
pixelSize:20,text:"Cancel",font:this.xfinity_sans_default,alignHorizontal:r,alignVertical:v});this.connectRect=a.create({t:"rect",parent:this.container,x:this.cancelRect.x+this.cancelRect.w+20,y:this.subTitle1.y+110,w:100,h:40,fillColor:e.BTNBACKGROUND});this.connectText=a.create({t:"textBox",parent:this.connectRect,textColor:e.WHITE,w:this.connectRect.w,h:this.connectRect.h,pixelSize:20,text:"Connect",font:this.xfinity_sans_default,alignHorizontal:r,alignVertical:v});this.loadingContainer=a.create({t:"object",
parent:this.container,w:60,h:14,x:this.container.w/2-40,y:this.container.h-300,a:0,interactive:!1});this.whiteCircleResource=a.create({t:"imageResource",w:16,h:16,url:p+"/images/whiteCircle.svg"});this.grayCircleResource=a.create({t:"imageResource",w:14,h:14,url:p+"/images/grayCircle.svg"});this.circle1=a.create({t:"image",parent:this.loadingContainer,w:14,h:14,x:0,resource:this.grayCircleResource});this.circle2=a.create({t:"image",parent:this.loadingContainer,w:14,h:14,x:23,resource:this.grayCircleResource});
this.circle3=a.create({t:"image",parent:this.loadingContainer,w:14,h:14,x:46,resource:this.grayCircleResource});this.circle4=a.create({t:"image",parent:this.loadingContainer,w:16,h:16,x:-1,y:-1,resource:this.whiteCircleResource});var k=[-1,22,45,45];this.keyboardContainer=a.create({t:"object",parent:this.container,w:b.w,h:250,y:this.container.h-250,interactive:!1});n=new m(a,{eventManager:q,keys:d,Colors:e,parent:this.keyboardContainer});var A=null,y=0;this.showLoadingIndicator=function(a){a?(g.loadingContainer.a=
1,A=setInterval(function(){y++;3<y&&(y=0);g.circle4.x=k[y]},300)):(A&&clearInterval(A),g.loadingContainer.a=0)};this.setFocus=function(a){g.inputBox.focus=a};this.show=function(){g.inputBox.focus=!0};this.onKeyDown=function(a){var b=a.keyCode;b===d.DOWN?g.inputBox.focus&&(g.checkbox.lineColor=e.HIGHLIGHT,g.checkbox.focus=!0):b===d.UP&&n.focus&&(n.focus=!1,g.connectRect.focus=!0,g.connectRect.fillColor=e.HIGHLIGHT);a.stopPropagation()};a.root.on("onKeyDown",this.onKeyDown);this.checkbox.on("onKeyDown",
function(a){var b=a.keyCode;b===d.DOWN?(g.checkbox.lineColor=e.BACKGROUND1,g.connectRect.focus=!0,g.connectRect.fillColor=e.HIGHLIGHT,a.stopPropagation()):b===d.UP&&(g.checkbox.lineColor=e.BACKGROUND1,g.inputBox.focus=!0,a.stopPropagation())});this.checkbox.on("onKeyUp",function(a){a.keyCode===d.ENTER&&(0===g.checkImage.a?(g.checkImage.a=1,g.inputBox.echoMode="Normal"):(g.checkImage.a=0,g.inputBox.echoMode="Password"))});this.connectRect.on("onKeyDown",function(a){var b=a.keyCode;b===d.DOWN?(n.focus=
...
function WifiScreen(a,b){function d(){this.createUI=function(a){this.device=a.device;this.animate=400>a.y;this.signalImage=function(a){return-50<=a?k.signalEResource:-60<=a&&-50>a?k.signalGResource:-70<=a&&-60>a?k.signalFResource:k.signalWResource};this.itemRoot=e.create({t:"rect",parent:a.parent,x:0,y:a.y,w:a.w,h:a.h,fillColor:a.fillColor,a:this.animate?0:1,sx:this.animate?.5:1,sy:this.animate?.5:1,cx:a.w/2,cy:a.h/2});this.signalImageBG=e.create({t:"image",parent:this.itemRoot,w:40,h:40,x:20,y:10,
resource:k.imageBGResource});this.signalImage=e.create({t:"image",parent:this.signalImageBG,w:30,h:30,x:5,y:5,resource:this.signalImage(this.device.signalStrength)});this.securityImage=e.create({t:"image",parent:this.itemRoot,w:22,h:30,x:75,y:this.itemRoot.h/2-10,a:0<this.device.security?1:0,resource:k.securityResource});this.deviceName=e.create({t:"textBox",parent:this.itemRoot,textColor:f.TEXT,font:k.xfinity_sans_default,w:this.itemRoot.w,h:this.itemRoot.h,x:110,pixelSize:25,text:a.name,alignHorizontal:x,
alignVertical:B});this.deviceNameMargineLine=e.create({t:"rect",parent:this.itemRoot,w:this.itemRoot.w,h:2,y:this.itemRoot.h-2,fillColor:f.BLACK,a:.3});this.connectBG=e.create({t:"image",parent:this.itemRoot,w:120,h:30,x:this.itemRoot.w-180,y:this.itemRoot.h/2-15,resource:k.connectBGResource});this.status=e.create({t:"textBox",parent:this.connectBG,textColor:f.LIST_HIGHLIGHT,font:k.xfinity_sans_default,w:this.connectBG.w,h:this.connectBG.h,pixelSize:15,text:this.device.connected?"CONNECTED":"CONNECT",
alignHorizontal:t,alignVertical:B});this.moreOptions=e.create({t:"object",parent:this.itemRoot,w:30,h:30,x:this.itemRoot.w-50,y:this.itemRoot.h/2-15,cx:15,cy:15});this.rightImage=e.create({t:"image",parent:this.moreOptions,w:this.moreOptions.w,h:this.moreOptions.h,resource:k.moreOptionsResource});return this.animate?this.itemRoot.animateTo({sx:1,sy:1,a:1},.3,H,D,1):new Promise(function(a,b){a("sucess")})};this.y=function(){return this.itemRoot.y};this.selectItem=function(a){a?(this.itemRoot.fillColor=
f.LIST_HIGHLIGHT,this.deviceName.textColor=f.WHITE,this.connectBG.resource=k.connectBGHLResource):(this.itemRoot.fillColor=f.LIST_NORMAL,this.deviceName.textColor=f.TEXT,this.connectBG.resource=k.connectBGResource);this.rightImage.resource=k.moreOptionsResource};this.updateStatus=function(a){var b=this;this.status.text=a;setTimeout(function(){b.status.text=b.device.connected?"CONNECTED":"CONNECT"},3E4)};this.selectMoreOptions=function(a){a?(this.itemRoot.fillColor=f.LIST_NORMAL,this.deviceName.textColor=
f.TEXT,this.rightImage.resource=k.moreOptionsHLResource,this.connectBG.resource=k.connectBGHLResource):(this.rightImage.resource=k.moreOptionsResource,this.connectBG.resource=k.connectBGResource)};this.isMoreOptionsSelected=function(){return this.rightImage.resource==k.moreOptionsHLResource?!0:!1};this.click=function(a){var b=this;this.rightImage.resource==k.moreOptionsHLResource?(this.moreOptions.animateTo({sx:1.3,sy:1.3},.1,C,D,1).then(function(){b.moreOptions.animateTo({sx:1,sy:1},.1,C,D,1)}),
w=new v(e,{parent:k,eventManager:n,keys:c,baseUrl:p,Colors:f,device:this.device,_owner:g,title:"Network Details",description:this.deviceName.text,w:600,h:250,x:this.itemRoot.x+25,y:this.itemRoot.y+k.scrolledView.y+290,cx:0,cy:0,yes:{text:"Modify"},no:{text:"Forget"}}),w.ready.then(function(){w.show()}).catch(function(a){console.log(a)})):0<this.device.security?(u=new r(e,{eventManager:n,Keyboard:q,EditBox:m,keys:c,Colors:f,parent:k.container,device:this.device}),u.show()):(a.ssid=this.device.ssid,
a.password="",a.security=this.device.security,this.updateStatus("CONNECTING..."),g.fireEvent("connect",a))}}var e=a,c=b.keys;a=b.parent;var f=b.Colors,m=b.EditBox,q=b.Keyboard,g=b.context,n=b.eventManager,r=b.Wifipassword,v=b.NetworkDetails,p=global.registry.baseUrl,k=this,A=-1,y=-1,l=[],u=null,w=null,t=e.alignHorizontal.CENTER,x=e.alignHorizontal.LEFT,B=e.alignVertical.CENTER,C=e.animation.TWEEN_EXP1,H=e.animation.TWEEN_LINEAR,Q=e.animation.OPTION_LOOP,D=e.animation.OPTION_FASTFORWARD,E=[],M=[];
this.onPopulateDevices=function(a){E=a;l.length=0;k.scrolledView.y=0;A=y=-1;k.wifiImage.resource=k.wifiWResource;k.deviceName.text="";k.deviceIP.text="";k.loadingIndicator.hide();0==E.length?(k.scrolledView.removeAll(),k.topMargineLine.a=0,0===M.length&&(k.refreshNetworkList.focus=!0,k.refreshNetworkImage.resource=k.refreshNetworkHLResource),k.emptyListText&&k.emptyListText.animateTo({sx:1,sy:1,a:1},.3,C,D,1)):(0===M.length&&(k.refreshNetworkImage.resource=k.refreshNetworkResource,k.refreshNetworkList.focus=
!1,k.scrolledView.focus=!0),k.emptyListText&&k.emptyListText.animateTo({sx:0,sy:0,a:0},.3,C,D,1),k.scrolledView.removeAll(),k.topMargineLine.a=.3,k.populateItem(),k.selectItem(0))};this.onStartDiscovery=function(){k.loadingIndicator.show()};this.onError=function(){k.loadingIndicator.hide()};this.onPopupClose=function(){k.scrolledView.focus=!0};this.onWifiPasswordClose=function(){delete u;u=null;k.scrolledView.focus=!0};this.onConnectRequest=function(a){g.fireEvent("connect",a)};this.onWIFIStateChanged=
function(a){n.fireEvent("onWIFIStateChanged",a)};this.onError=function(a){n.fireEvent("onError",a)};this.onPairingStateChanged=function(a){n.fireEvent("onPairingStateChanged",a)};this.setIPAddress=function(a){k.deviceIP.text=a};n.on("wifiPasswordClose",this.onWifiPasswordClose);n.on("connectRequest",this.onConnectRequest);Object.defineProperty(this,"focus",{set:function(a){this.refreshNetworkImage.resource=a?k.refreshNetworkHLResource:k.refreshNetworkResource;this.refreshNetworkList.focus=a},get:function(){return this.refreshNetworkList.focus}});
this.xfinity_sans_default=e.create({t:"fontResource",url:p+"/fonts/XFINITYSansTT.ttf"});this.xfinity_sans_medium=e.create({t:"fontResource",url:p+"/fonts/XFINITYSansTT-Medium.ttf"});this.container=e.create({t:"object",parent:a,w:a.w,h:a.h,interactive:!1});this.title=e.create({t:"textBox",parent:this.container,textColor:f.TEXT,x:15,y:20,w:650,h:40,pixelSize:28,text:"Xfinity WiFi Settings",cx:325,cy:20,font:this.xfinity_sans_default,alignHorizontal:x,alignVertical:B});this.rightLayout=e.create({t:"object",
parent:this.container,w:350,h:e.h-250,x:800,y:80});this.refreshNetworkResource=e.create({t:"imageResource",url:p+"/images/refreshNetwork.svg",w:350,h:50});this.refreshNetworkHLResource=e.create({t:"imageResource",url:p+"/images/refreshNetworkHL.svg",w:350,h:50});this.refreshNetworkImage=e.create({t:"image",parent:this.rightLayout,w:350,h:50,x:0,y:this.rightLayout.h-100,resource:this.refreshNetworkResource});this.refreshNetworkList=e.create({t:"textBox",parent:this.refreshNetworkImage,textColor:f.WHITE,
w:this.refreshNetworkImage.w,h:this.refreshNetworkImage.h,pixelSize:28,text:"Refresh Network List",alignHorizontal:t,alignVertical:B,font:this.xfinity_sans_default,cx:this.refreshNetworkImage.w/2,cy:this.refreshNetworkImage.h/2});this.rightSidecontainer=e.create({t:"object",parent:this.container,w:300,h:a.h,x:a.w-450,interactive:!1});this.wifiWResource=e.create({t:"imageResource",url:p+"/images/wifiW.svg",w:120,h:120});this.wifiFResource=e.create({t:"imageResource",url:p+"/images/wifiF.svg",w:120,
h:120});this.wifiGResource=e.create({t:"imageResource",url:p+"/images/wifiG.svg",w:120,h:120});this.wifiEResource=e.create({t:"imageResource",url:p+"/images/wifiE.svg",w:120,h:120});this.wifiImage=e.create({t:"image",parent:this.rightLayout,w:120,h:120,x:this.rightLayout.w/2-60,y:80,resource:this.wifiWResource});this.deviceName=e.create({t:"textBox",parent:this.rightLayout,textColor:f.WHITE,x:this.rightLayout.w/2-150,y:200,w:300,h:100,pixelSize:24,text:"",font:this.xfinity_sans_default,alignHorizontal:t});
this.deviceIP=e.create({t:"textBox",parent:this.rightLayout,textColor:f.WHITE,x:this.rightLayout.w/2-150,y:230,w:300,h:100,pixelSize:24,text:"",font:this.xfinity_sans_default,alignHorizontal:t});this.listviewParent=e.create({t:"rect",parent:this.container,w:650,h:e.h-250,x:15,y:80,fillColor:f.LISTPARENT,interactive:!1});this.header=e.create({t:"textBox",parent:this.listviewParent,textColor:f.HEADER,x:20,y:20,w:630,h:40,pixelSize:28,text:"Wireless Network Connections",font:this.xfinity_sans_default,
alignHorizontal:x,alignVertical:B});this.listview=e.create({t:"object",parent:this.listviewParent,x:0,y:80,w:this.listviewParent.w,h:this.listviewParent.h-80,clip:!0});this.emptyListText=e.create({t:"textBox",parent:this.listview,textColor:f.TEXT,x:0,y:-80,w:this.listview.w,h:this.listview.h,pixelSize:25,text:"No Wi-Fi network found.",alignHorizontal:t,alignVertical:B,cx:this.listview.w/2,cy:this.listview.h/2,font:this.xfinity_sans_default});this.scrolledView=e.create({t:"object",parent:this.listview});
this.topMargineLine=e.create({t:"rect",parent:this.listviewParent,w:this.listview.w,h:2,y:78,fillColor:f.BLACK,a:0});this.loadingIndicatorResource=e.create({t:"imageResource",url:p+"/images/loadingIndicator.svg",w:50,h:50});this.loadingIndicator={image:e.create({t:"image",parent:this.listview,w:50,h:50,x:this.listview.w/2-25,y:this.listview.h/2-25,cx:25,cy:25,resource:k.loadingIndicatorResource,a:0,stretchX:e.stretch.STRETCH,stretchY:e.stretch.STRETCH}),animate:null,show:function(){this.animate&&
(this.animate.cancel(),this.animate=null);this.image.a=1;this.animate=this.image.animate({r:360},1.5,e.animation.TWEEN_LINEAR,e.animation.OPTION_REWIND,e.animation.COUNT_FOREVER)},hide:function(){this.animate&&(this.animate.cancel(),this.animate=null);this.image.a=0}};this.moreOptionsResource=e.create({t:"imageResource",w:30,h:30,url:p+"/images/moreOptionsW.svg"});this.moreOptionsHLResource=e.create({t:"imageResource",w:30,h:30,url:p+"/images/moreOptionsHLW.svg"});this.smokecircleResource=e.create({t:"imageResource",
w:34,h:34,url:p+"/images/smokecircle.svg"});this.tickResource=e.create({t:"imageResource",w:25,h:25,url:p+"/images/check.svg"});this.signalWResource=e.create({t:"imageResource",w:28,h:30,url:p+"/images/wifiW.svg"});this.signalFResource=e.create({t:"imageResource",w:28,h:30,url:p+"/images/wifiF.svg"});this.signalGResource=e.create({t:"imageResource",w:28,h:30,url:p+"/images/wifiG.svg"});this.signalEResource=e.create({t:"imageResource",w:28,h:30,url:p+"/images/wifiE.svg"});this.securityResource=e.create({t:"imageResource",
w:22,h:30,url:p+"/images/lock.svg"});this.imageBGResource=e.create({t:"imageResource",w:40,h:40,url:p+"/images/imageBG.svg"});this.connectBGResource=e.create({t:"imageResource",w:120,h:30,url:p+"/images/connectBG.svg"});this.connectBGHLResource=e.create({t:"imageResource",w:120,h:30,url:p+"/images/connectBGHL.svg"});this.populateItem=function(){if(l.length!=E.length){var a=l.length,b=E[a],c=b.ssid;b.connected&&(k.wifiImage.resource=function(a){return-50<=a?k.wifiEResource:-60<=a&&-50>a?k.wifiGResource:
-70<=a&&-60>a?k.wifiFResource:-70>a?k.wifiWResource:k.wifiEResource}(b.signalStrength),k.deviceName.text=c,k.deviceIP.text="",g.fireEvent("getIPAddress",0));var e=new d;l.push(e);e.createUI({parent:this.scrolledView,y:60*a,w:this.listview.w,h:60,fillColor:f.LIST_NORMAL,name:c,device:b}).then(function(){k.populateItem()}).catch(function(a){console.log("promise failed in populateItem")})}};this.selectItem=function(a){var b=l[a],c=-k.scrolledView.y;y=a;0<=A&&l[A].selectItem(!1);l[y].selectItem(!0);A=
y;b.y()<c?(c=-b.y(),k.scrolledView.animateTo({y:c},.1,H,Q,1)):b.y()+60-k.listview.h>c&&(c=-(b.y()+60-k.listview.h),k.scrolledView.animateTo({y:c},.1,H,Q,1))};this.scrolledView.on("onKeyDown",function(a){var b=a.keyCode,d=l.length;b==c.UP?(k.selectItem(Math.min(Math.max(0,y-1),d-1)),a.stopPropagation()):b==c.DOWN?(y===d-1?(l[y].selectItem(!1),k.refreshNetworkImage.resource=k.refreshNetworkHLResource,k.refreshNetworkList.focus=!0):k.selectItem(Math.min(Math.max(0,y+1),d-1)),a.stopPropagation()):b==
c.LEFT?0<=y&&y<d&&(l[y].isMoreOptionsSelected()?(l[y].selectItem(!0),a.stopPropagation()):(l[y].selectItem(!1),k.scrolledView.focus=!1)):b==c.RIGHT?0<=y&&y<d&&(l[y].isMoreOptionsSelected()?(l[y].selectItem(!1),k.refreshNetworkImage.resource=k.refreshNetworkHLResource,k.refreshNetworkList.focus=!0):l[y].selectMoreOptions(!0),a.stopPropagation()):b==c.ENTER&&a.stopPropagation()});this.scrolledView.on("onKeyUp",function(a){var b=l.length;a.keyCode==c.ENTER&&(0<=y&&y<b&&l[y].click(a),a.stopPropagation(),
console.log("on item click"+y))});this.refreshNetworkList.on("onKeyDown",function(a){var b=a.keyCode;b==c.UP?(l[y].selectItem(!0),k.refreshNetworkImage.resource=k.refreshNetworkResource,k.scrolledView.focus=!0,a.stopPropagation()):b==c.ENTER?(k.refreshNetworkList.animateTo({sx:1.1,sy:1.1},.1,C,D,1).then(function(){k.refreshNetworkList.animateTo({sx:1,sy:1},.1,C,D,1)}),a.stopPropagation(),console.log("this.refreshNetworkList event")):b==c.RIGHT?a.stopPropagation():b==c.LEFT&&(l[y].selectItem(!0),k.refreshNetworkImage.resource=
k.refreshNetworkResource,k.scrolledView.focus=!0,a.stopPropagation(),a.stopPropagation())});this.refreshNetworkList.on("onKeyUp",function(a){a.keyCode==c.ENTER&&g.fireEvent("getAvailableSSIDsAsync",a)})}module.exports.WifiScreen=WifiScreen;
var WifiSettings=function(){function a(){d.doHttpPost({hostname:"127.0.0.1",port:10999,method:"POST",headers:{"Content-Type":"application/json"}},'{"paramList" : [             {"name" : "Device.DeviceInfo.X_COMCAST-COM_STB_IP"}             ]}').then(function(a){for(var b=0;b<a.paramList.length;b++)if("Device.DeviceInfo.X_COMCAST-COM_STB_IP"===a.paramList[b].name){u.setIPAddress(a.paramList[b].value);break}},function(a){u.setIPAddress("0.0.0.0")})}function b(){this.show=function(a){var b=this;this.toastRoot=
c.create({t:"rect",parent:l,x:l.w/2-a.w/2,y:l.h-100,w:a.w,h:a.h,fillColor:k.TALL_POPPY,a:0,sx:0,sy:0,cx:a.w/2,cy:a.h/2,lineColor:k.WHITE,lineWidth:2});this.deviceName=c.create({t:"textBox",parent:this.toastRoot,textColor:k.WHITE,font:w,w:this.toastRoot.w,h:this.toastRoot.h,pixelSize:25,text:a.message,alignHorizontal:c.alignHorizontal.CENTER,alignVertical:c.alignVertical.CENTER});this.toastRoot.animateTo({sx:1,sy:1,a:1},.3,c.animation.TWEEN_EXP1,c.animation.OPTION_FASTFORWARD,1).then(setTimeout(function(){b.toastRoot.animateTo({y:l.h,
a:0},.3,c.animation.TWEEN_EXP1,c.animation.OPTION_FASTFORWARD,1).then(setTimeout(function(){b.toastRoot.remove();b.toastRoot=null},1E3))},2E3))}}var d=global.registry.all.Utils,e=global.registry.keyCodes,c=global.registry.scene,f=global.registry.all.EditBox,m=global.registry.all.Keyboard,q=global.registry.all.WifiScreen,g=global.registry.all.WifiPassword,n=global.registry.all.WifiEventManager,r=global.registry.all.NetworkDetails,v=global.registry.all.Wifi,p=global.registry.all.BaseEventManager,k=
global.registry.all.Colors,A=global.registry.all.Logger,y=px.getPackageBaseFilePath(),l=null,u=null,w=c.create({t:"fontResource",url:y+"/fonts/XFINITYSansTT.ttf"}),t={user_accepted_pairing:!1,known_devices:null,discovered_devices:null,paired_devices:null,connected_devices:null,_owner:null,_actions:new Map,_aip:!1,_aip_handler:null,_aip_timeout:30,_aip_timer_id:null,populateDevices:function(){var a=this;this.known_devices=new Map;this._owner.log("Populating devices.");if(this.paired_devices&&0<this.paired_devices.length){for(var b=
...
updateSceneDetails:function(a,b){switch(a){case "populateDevices":if(t.known_devices)u.onPopulateDevices(Array.from(t.known_devices.values()));break;case "pairingRequest":u.onPairingRequest(b);break;case "connectionRequest":u.onConnectionRequest(b)}}};p.call(x);A.call(Object.getPrototypeOf(x));x.api_event_listeners.set("onError",function(a){this.log("API event: onError.",JSON.stringify(a));u.onError(a);(new b).show({message:"A connection error has occurred ",w:600,h:50})});x.api_event_listeners.set("onSSIDsChanged",
function(a){this.log("API event: onSSIDsChanged.");this.log(JSON.stringify(a))});x.api_event_listeners.set("onPairingStateChanged",function(a){this.log("API event: onPairingStateChanged.");this.log(JSON.stringify(a));u.onPairingStateChanged(a)});x.api_event_listeners.set("onWPSPairingButtonPressed",function(a){this.log("API event: onWPSPairingButtonPressed.");this.log(JSON.stringify(a))});x.api_event_listeners.set("onWifiSignalThresholdChanged",function(a){this.log("API event: onWifiSignalThresholdChanged.");
this.log(JSON.stringify(a))});x.api_event_listeners.set("onWIFIStateChanged",function(a){this.log("API event: onWIFIStateChanged.",JSON.stringify(a));if(5==a.state){var b=this.api.getConnectedSSID();this.log("API event: onWIFIStateChanged. connected devices",b);var c=null;if(b.hasOwnProperty("SSID")){var d=b.SSID;d.hasOwnProperty("ssid")&&0<d.ssid.length&&(c=b.SSID)}t.connected_devices=[];c&&(c.connected=!0,c.hasOwnProperty("security")||(c.security=2),t.connected_devices.push(c),this.log("Device %s added to connected devices",
c.ssid));t.populateDevices();this.updateSceneDetails("populateDevices")}u.onWIFIStateChanged(a)});x.api_event_listeners.set("onAvailableSSIDs",function(a){this.log("API event: onAvailableSSIDs.");this.log(JSON.stringify(a));var b;a.hasOwnProperty("SSIDs")&&(b=a.SSIDs);t.discovered_devices=new Map;a=$jscomp.makeIterator(b);for(b=a.next();!b.done;b=a.next())b=b.value,t.discovered_devices.has(b.ssid)||(b.connected=!1,t.discovered_devices.set(b.ssid,b),this.log("Device %s added to known devices",b.ssid));
t.populateDevices();this.updateSceneDetails("populateDevices")});x.event_listeners.set("onStartingUp",function(a){this.log("Handling onStartingUp event.");a=this.api.getConnectedSSID();this.log("API event: onStartingUp.",a);var b=null;if(a.hasOwnProperty("SSID")){var c=a.SSID;c.hasOwnProperty("ssid")&&0<c.ssid.length&&(b=a.SSID)}t.connected_devices=[];b&&0<Object.keys(b).length&&(b.connected=!0,b.hasOwnProperty("security")||(b.security=2),t.connected_devices.push(b),this.log("Device %s added to connected devices",
b.ssid));t.populateDevices();this.log("Handling onStartingUp event: done.")});x.event_listeners.set("setEnabled",function(a){this.api.setEnabled(a.enable)});x.event_listeners.set("getAvailableSSIDsAsync",function(){u.onStartDiscovery();var a=this.api.getAvailableSSIDs();this.log(JSON.stringify(a));var b;a.hasOwnProperty("SSIDs")&&(b=a.SSIDs);t.discovered_devices=new Map;b=$jscomp.makeIterator(b);for(var c=b.next();!c.done;c=b.next())c=c.value,t.discovered_devices.has(c.ssid)||(c.connected=!1,t.discovered_devices.set(c.ssid,
c),this.log("Device %s added to known devices",c.ssid));t.populateDevices();this.updateSceneDetails("populateDevices");this.log("getAvailableSSIDsAsync Status: ",a.success)});x.event_listeners.set("getIPAddress",function(b){a()});x.event_listeners.set("connect",function(a){a=this.api.connect(a.ssid,a.password,a.security);this.log("connect Status: %s",JSON.stringify(a))});x.event_listeners.set("onclearSSID",function(a){console.log("#####################onclearSSID");a=this.api.clearSSID();if(1==a.success){this.log("ssids cleared");
var b=this.api.getConnectedSSID(),c=null;if(b.hasOwnProperty("SSID")){var d=b.SSID;d.hasOwnProperty("ssid")&&0<d.ssid.length&&(c=b.SSID)}t.connected_devices=[];c&&(c.connected=!0,c.hasOwnProperty("security")||(c.security=2),t.connected_devices.push(c),this.log("Device %s added to connected devices",c.ssid));t.populateDevices();this.updateSceneDetails("populateDevices")}this.log("onclearSSID Status: %s",JSON.stringify(a))});this.isBluetoothScreen=!0;this.setService=function(a){x.init({service:a,api_version:4});
x.run()};this.show=function(a){a.clear();a.addRow(function(a,b){b.h=580;l=c.create({t:"object",parent:a,w:b.w,h:b.h,x:b.x,y:b.y});u=new q(c,{parent:l,Keyboard:m,eventManager:n,Wifipassword:g,EditBox:f,NetworkDetails:r,keys:e,Popup:null,Colors:k,context:x})})};this.refresh=function(){u.focus=!0;x.updateSceneDetails("populateDevices")}};module.exports.WifiSettings=WifiSettings;
...
var XreStatus=function(a){var b=global.registry.all.DetailsItem,d=global.registry.all.Utils,e={};this.show=function(){var c=new b(d.scene,a);c.setSeparatorPlacement(.4);e["Device.X_COMCAST-COM_Xcalibur.Client.XRE.xreVersion"]=c.addRow("XRE Server Version","TBD");e["Device.X_COMCAST-COM_Xcalibur.Client.XRE.xreSessionLastModTs"]=c.addRow("Last XRE Reconnect Date/Time","TODO");e["Device.X_COMCAST-COM_Xcalibur.Client.XRE.xreStatus"]=c.addRow("XRE Connection Status","TODO");e["Device.X_COMCAST-COM_Xcalibur.Client.XRE.xreSessionUptime"]=
